...
open class InputContext: java_swift.JavaObject {
    ...
    private static var dispatchEvent_MethodID_3: jmethodID?

    open func dispatchEvent( event: AWTEvent? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: event, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dispatchEvent", methodSig: "(Ljava/awt/AWTEvent;)V", methodCache: &InputContext.dispatchEvent_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var endComposition_MethodID_5: jmethodID?

    open func endComposition() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "endComposition", methodSig: "()V", methodCache: &InputContext.endComposition_MethodID_5, args: &__args, locals: &__locals )
    }


    /// public java.lang.Object java.awt.im.InputContext.getInputMethodControlObject()

    private static var getInputMethodControlObject_MethodID_6: jmethodID?

    open func getInputMethodControlObject() -> java_swift.JavaObject! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getInputMethodControlObject", methodSig: "()Ljava/lang/Object;", methodCache: &InputContext.getInputMethodControlObject_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getLocale_MethodID_7: jmethodID?

    open func getLocale() -> java_util.JavaLocale! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLocale", methodSig: "()Ljava/util/Locale;", methodCache: &InputContext.getLocale_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func removeNotify( client: Component? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeNotify", methodSig: "(Ljava/awt/Component;)V", methodCache: &InputContext.removeNotify_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var selectInputMethod_MethodID_11: jmethodID?

    open func selectInputMethod( locale: java_util.JavaLocale? ) -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: locale, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "selectInputMethod", methodSig: "(Ljava/util/Locale;)Z", methodCache: &InputContext.selectInputMethod_MethodID_11, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var setCharacterSubsets_MethodID_12: jmethodID?

    open func setCharacterSubsets( subsets: [Character_Subset]? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: subsets, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCharacterSubsets", methodSig: "([Ljava/lang/Character$Subset;)V", methodCache: &InputContext.setCharacterSubsets_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var setCompositionEnabled_MethodID_13: jmethodID?

    open func setCompositionEnabled( enable: Bool ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( z: jboolean(enable ? JNI_TRUE : JNI_FALSE) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCompositionEnabled", methodSig: "(Z)V", methodCache: &InputContext.setCompositionEnabled_MethodID_13, args: &__args, locals: &__locals )
    }
