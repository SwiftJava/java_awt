...
open class CanvasPeerForward: ComponentPeerForward, CanvasPeer {
    ...
    override open func applyShape( shape: /* class sun.java2d.pipe.Region */ UnavailableObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "applyShape", methodSig: "(Lsun/java2d/pipe/Region;)V", methodCache: &CanvasPeerForward.applyShape_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    override open func canDetermineObscurity() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "canDetermineObscurity", methodSig: "()Z", methodCache: &CanvasPeerForward.canDetermineObscurity_MethodID_3, args: &__args, locals: &__locals )
    ...
    override open func checkImage( img: Image?, w: Int, h: Int, o: ImageObserver? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "checkImage", methodSig: "(Ljava/awt/Image;IILjava/awt/image/ImageObserver;)I", methodCache: &CanvasPeerForward.checkImage_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    override open func coalescePaintEvent( e: PaintEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "coalescePaintEvent", methodSig: "(Ljava/awt/event/PaintEvent;)V", methodCache: &CanvasPeerForward.coalescePaintEvent_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    override open func createBuffers( numBuffers: Int, caps: BufferCapabilities? ) throws /* java.awt.AWTException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "createBuffers", methodSig: "(ILjava/awt/BufferCapabilities;)V", methodCache: &CanvasPeerForward.createBuffers_MethodID_6, args: &__args, locals: &__locals )
    ...
    override open func createImage( producer: ImageProducer? ) -> Image! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createImage", methodSig: "(Ljava/awt/image/ImageProducer;)Ljava/awt/Image;", methodCache: &CanvasPeerForward.createImage_MethodID_7, args: &__args, locals: &__locals )
    ...
    override open func createVolatileImage( width: Int, height: Int ) -> VolatileImage! {
        ...
        __args[0] = jvalue( i: jint(width) )
        __args[1] = jvalue( i: jint(height) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createVolatileImage", methodSig: "(II)Ljava/awt/image/VolatileImage;", methodCache: &CanvasPeerForward.createVolatileImage_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func destroyBuffers() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "destroyBuffers", methodSig: "()V", methodCache: &CanvasPeerForward.destroyBuffers_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    override open func dispose() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dispose", methodSig: "()V", methodCache: &CanvasPeerForward.dispose_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    override open func flip( x1: Int, y1: Int, x2: Int, y2: Int, flipAction: BufferCapabilities_FlipContents? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "flip", methodSig: "(IIIILjava/awt/BufferCapabilities$FlipContents;)V", methodCache: &CanvasPeerForward.flip_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var getAppropriateGraphicsConfiguration_MethodID_13: jmethodID?
    ...
    open func getAppropriateGraphicsConfiguration( gc: GraphicsConfiguration? ) -> GraphicsConfiguration! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAppropriateGraphicsConfiguration", methodSig: "(Ljava/awt/GraphicsConfiguration;)Ljava/awt/GraphicsConfiguration;", methodCache: &CanvasPeerForward.getAppropriateGraphicsConfiguration_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getBackBuffer() -> Image! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBackBuffer", methodSig: "()Ljava/awt/Image;", methodCache: &CanvasPeerForward.getBackBuffer_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Image( javaObject: __return ) : nil
    }
    ...
    override open func getColorModel() -> ColorModel! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColorModel", methodSig: "()Ljava/awt/image/ColorModel;", methodCache: &CanvasPeerForward.getColorModel_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getFontMetrics( font: Font? ) -> FontMetrics! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFontMetrics", methodSig: "(Ljava/awt/Font;)Ljava/awt/FontMetrics;", methodCache: &CanvasPeerForward.getFontMetrics_MethodID_16, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getGraphicsConfiguration() -> GraphicsConfiguration! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getGraphicsConfiguration", methodSig: "()Ljava/awt/GraphicsConfiguration;", methodCache: &CanvasPeerForward.getGraphicsConfiguration_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? GraphicsConfiguration( javaObject: __return ) : nil
    }
    ...
    override open func getLocationOnScreen() -> Point! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLocationOnScreen", methodSig: "()Ljava/awt/Point;", methodCache: &CanvasPeerForward.getLocationOnScreen_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getMinimumSize() -> Dimension! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &CanvasPeerForward.getMinimumSize_MethodID_20, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getPreferredSize() -> Dimension! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreferredSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &CanvasPeerForward.getPreferredSize_MethodID_21, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Dimension( javaObject: __return ) : nil
    }
    ...
    override open func handleEvent( e: AWTEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "handleEvent", methodSig: "(Ljava/awt/AWTEvent;)V", methodCache: &CanvasPeerForward.handleEvent_MethodID_22, args: &__args, locals: &__locals )
    }
    ...
    override open func handlesWheelScrolling() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "handlesWheelScrolling", methodSig: "()Z", methodCache: &CanvasPeerForward.handlesWheelScrolling_MethodID_23, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func isFocusable() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFocusable", methodSig: "()Z", methodCache: &CanvasPeerForward.isFocusable_MethodID_24, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func isObscured() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isObscured", methodSig: "()Z", methodCache: &CanvasPeerForward.isObscured_MethodID_25, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func isReparentSupported() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isReparentSupported", methodSig: "()Z", methodCache: &CanvasPeerForward.isReparentSupported_MethodID_26, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func layout() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "layout", methodSig: "()V", methodCache: &CanvasPeerForward.layout_MethodID_27, args: &__args, locals: &__locals )
    }
    ...
    override open func paint( g: Graphics? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &CanvasPeerForward.paint_MethodID_28, args: &__args, locals: &__locals )
    }
    ...
    override open func prepareImage( img: Image?, w: Int, h: Int, o: ImageObserver? ) -> Bool {
        ...
        __args[2] = jvalue( i: jint(h) )
        __args[3] = JNIType.toJava( value: o, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "prepareImage", methodSig: "(Ljava/awt/Image;IILjava/awt/image/ImageObserver;)Z", methodCache: &CanvasPeerForward.prepareImage_MethodID_29, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func print( g: Graphics? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: g, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "print", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &CanvasPeerForward.print_MethodID_30, args: &__args, locals: &__locals )
    }
    ...
    override open func reparent( newContainer: ContainerPeer? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "reparent", methodSig: "(Ljava/awt/peer/ContainerPeer;)V", methodCache: &CanvasPeerForward.reparent_MethodID_31, args: &__args, locals: &__locals )
    }
    ...
    override open func requestFocus( lightweightChild: Component?, temporary: Bool, focusedWindowChangeAllowed: Bool, time: Int64, cause: /* class sun.awt.CausedFocusEvent$Cause */ UnavailableEnum? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "requestFocus", methodSig: "(Ljava/awt/Component;ZZJLsun/awt/CausedFocusEvent$Cause;)Z", methodCache: &CanvasPeerForward.requestFocus_MethodID_32, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func setBackground( c: Color? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBackground", methodSig: "(Ljava/awt/Color;)V", methodCache: &CanvasPeerForward.setBackground_MethodID_33, args: &__args, locals: &__locals )
    }
    ...
    override open func setEnabled( e: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setEnabled", methodSig: "(Z)V", methodCache: &CanvasPeerForward.setEnabled_MethodID_35, args: &__args, locals: &__locals )
    }
    ...
    override open func setFont( f: Font? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setFont", methodSig: "(Ljava/awt/Font;)V", methodCache: &CanvasPeerForward.setFont_MethodID_36, args: &__args, locals: &__locals )
    }
    ...
    override open func setForeground( c: Color? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setForeground", methodSig: "(Ljava/awt/Color;)V", methodCache: &CanvasPeerForward.setForeground_MethodID_37, args: &__args, locals: &__locals )
    }
    ...
    override open func setVisible( v: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setVisible", methodSig: "(Z)V", methodCache: &CanvasPeerForward.setVisible_MethodID_38, args: &__args, locals: &__locals )
    }
    ...
    override open func setZOrder( above: ComponentPeer? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setZOrder", methodSig: "(Ljava/awt/peer/ComponentPeer;)V", methodCache: &CanvasPeerForward.setZOrder_MethodID_39, args: &__args, locals: &__locals )
    }
    ...
    override open func updateCursorImmediately() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "updateCursorImmediately", methodSig: "()V", methodCache: &CanvasPeerForward.updateCursorImmediately_MethodID_40, args: &__args, locals: &__locals )
    }
    ...
    override open func updateGraphicsData( gc: GraphicsConfiguration? ) -> Bool {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: gc, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "updateGraphicsData", methodSig: "(Ljava/awt/GraphicsConfiguration;)Z", methodCache: &CanvasPeerForward.updateGraphicsData_MethodID_41, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
