...
open class ItemEvent: AWTEvent {
    ...
    override open var consumed: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "consumed", fieldType: "Z", fieldCache: &ItemEvent.consumed_FieldID, object: javaObject )
    ...
    override open var id: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "id", fieldType: "I", fieldCache: &ItemEvent.id_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var source: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &ItemEvent.source_FieldID, object: javaObject )
    ...
    public convenience init( source: ItemSelectable?, id: Int, item: java_swift.JavaObject?, stateChange: Int ) {
        ...
        __args[3] = jvalue( i: jint(stateChange) )
    ...
    private static var getItem_MethodID_2: jmethodID?

    open func getItem() -> java_swift.JavaObject! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getItem", methodSig: "()Ljava/lang/Object;", methodCache: &ItemEvent.getItem_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getItemSelectable_MethodID_3: jmethodID?

    open func getItemSelectable() -> ItemSelectable! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getItemSelectable", methodSig: "()Ljava/awt/ItemSelectable;", methodCache: &ItemEvent.getItemSelectable_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getStateChange_MethodID_4: jmethodID?

    open func getStateChange() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getStateChange", methodSig: "()I", methodCache: &ItemEvent.getStateChange_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
