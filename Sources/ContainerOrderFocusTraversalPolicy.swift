...
open class ContainerOrderFocusTraversalPolicy: FocusTraversalPolicy, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var setImplicitDownCycleTraversal_MethodID_8: jmethodID?

    open func setImplicitDownCycleTraversal( arg0: Bool ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setImplicitDownCycleTraversal", methodSig: "(Z)V", methodCache: &ContainerOrderFocusTraversalPolicy.setImplicitDownCycleTraversal_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func getImplicitDownCycleTraversal() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "getImplicitDownCycleTraversal", methodSig: "()Z", methodCache: &ContainerOrderFocusTraversalPolicy.getImplicitDownCycleTraversal_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
