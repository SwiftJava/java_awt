...
open class LineMetrics: java_lang.JavaObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.font.LineMetrics", file, line ) {
            return nil
        }
    ...
    private static var getHeight_MethodID_2: jmethodID?

    open func getHeight() -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getHeight", methodSig: "()F", methodCache: &LineMetrics.getHeight_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getLeading_MethodID_3: jmethodID?

    open func getLeading() -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getLeading", methodSig: "()F", methodCache: &LineMetrics.getLeading_MethodID_3, args: &__args, locals: &__locals )
        return JNIType.decode( type: Float(), from: __return )
    }
    ...
    open func getAscent() -> Float {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getAscent", methodSig: "()F", methodCache: &LineMetrics.getAscent_MethodID_4, args: &__args, locals: &__locals )
        return JNIType.decode( type: Float(), from: __return )
    }
    ...
    private static var getBaselineIndex_MethodID_6: jmethodID?

    open func getBaselineIndex() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getBaselineIndex", methodSig: "()I", methodCache: &LineMetrics.getBaselineIndex_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var getBaselineOffsets_MethodID_7: jmethodID?

    open func getBaselineOffsets() -> [Float]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBaselineOffsets", methodSig: "()[F", methodCache: &LineMetrics.getBaselineOffsets_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.decode( type: [Float](), from: __return )
    }
