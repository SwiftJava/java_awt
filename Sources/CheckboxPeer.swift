...
open class CheckboxPeerForward: ComponentPeerForward, CheckboxPeer {
    ...
    override open func applyShape( shape: /* class sun.java2d.pipe.Region */ UnavailableObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "applyShape", methodSig: "(Lsun/java2d/pipe/Region;)V", methodCache: &CheckboxPeerForward.applyShape_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    override open func canDetermineObscurity() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "canDetermineObscurity", methodSig: "()Z", methodCache: &CheckboxPeerForward.canDetermineObscurity_MethodID_5, args: &__args, locals: &__locals )
    ...
    override open func checkImage( img: Image?, w: Int, h: Int, o: ImageObserver? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "checkImage", methodSig: "(Ljava/awt/Image;IILjava/awt/image/ImageObserver;)I", methodCache: &CheckboxPeerForward.checkImage_MethodID_6, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    override open func coalescePaintEvent( e: PaintEvent? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "coalescePaintEvent", methodSig: "(Ljava/awt/event/PaintEvent;)V", methodCache: &CheckboxPeerForward.coalescePaintEvent_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    override open func createBuffers( numBuffers: Int, caps: BufferCapabilities? ) throws /* java.awt.AWTException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "createBuffers", methodSig: "(ILjava/awt/BufferCapabilities;)V", methodCache: &CheckboxPeerForward.createBuffers_MethodID_8, args: &__args, locals: &__locals )
    ...
    override open func createImage( producer: ImageProducer? ) -> Image! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createImage", methodSig: "(Ljava/awt/image/ImageProducer;)Ljava/awt/Image;", methodCache: &CheckboxPeerForward.createImage_MethodID_9, args: &__args, locals: &__locals )
    ...
    override open func createImage( width: Int, height: Int ) -> Image! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createImage", methodSig: "(II)Ljava/awt/Image;", methodCache: &CheckboxPeerForward.createImage_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Image( javaObject: __return ) : nil
    }
    ...
    override open func createVolatileImage( width: Int, height: Int ) -> VolatileImage! {
        ...
        __args[0] = jvalue( i: jint(width) )
        __args[1] = jvalue( i: jint(height) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createVolatileImage", methodSig: "(II)Ljava/awt/image/VolatileImage;", methodCache: &CheckboxPeerForward.createVolatileImage_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func destroyBuffers() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "destroyBuffers", methodSig: "()V", methodCache: &CheckboxPeerForward.destroyBuffers_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    override open func dispose() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dispose", methodSig: "()V", methodCache: &CheckboxPeerForward.dispose_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    override open func flip( x1: Int, y1: Int, x2: Int, y2: Int, flipAction: BufferCapabilities_FlipContents? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "flip", methodSig: "(IIIILjava/awt/BufferCapabilities$FlipContents;)V", methodCache: &CheckboxPeerForward.flip_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    override open func getBackBuffer() -> Image! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBackBuffer", methodSig: "()Ljava/awt/Image;", methodCache: &CheckboxPeerForward.getBackBuffer_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Image( javaObject: __return ) : nil
    }
    ...
    override open func getColorModel() -> ColorModel! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColorModel", methodSig: "()Ljava/awt/image/ColorModel;", methodCache: &CheckboxPeerForward.getColorModel_MethodID_16, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getFontMetrics_MethodID_17: jmethodID?

    override open func getFontMetrics( font: Font? ) -> FontMetrics! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: font, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFontMetrics", methodSig: "(Ljava/awt/Font;)Ljava/awt/FontMetrics;", methodCache: &CheckboxPeerForward.getFontMetrics_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getGraphics_MethodID_18: jmethodID?

    override open func getGraphics() -> Graphics! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getGraphics", methodSig: "()Ljava/awt/Graphics;", methodCache: &CheckboxPeerForward.getGraphics_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getGraphicsConfiguration_MethodID_19: jmethodID?

    override open func getGraphicsConfiguration() -> GraphicsConfiguration! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getGraphicsConfiguration", methodSig: "()Ljava/awt/GraphicsConfiguration;", methodCache: &CheckboxPeerForward.getGraphicsConfiguration_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getLocationOnScreen() -> Point! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLocationOnScreen", methodSig: "()Ljava/awt/Point;", methodCache: &CheckboxPeerForward.getLocationOnScreen_MethodID_20, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getMinimumSize() -> Dimension! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &CheckboxPeerForward.getMinimumSize_MethodID_21, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getPreferredSize() -> Dimension! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreferredSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &CheckboxPeerForward.getPreferredSize_MethodID_22, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Dimension( javaObject: __return ) : nil
    }
    ...
    override open func handleEvent( e: AWTEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "handleEvent", methodSig: "(Ljava/awt/AWTEvent;)V", methodCache: &CheckboxPeerForward.handleEvent_MethodID_23, args: &__args, locals: &__locals )
    }
    ...
    private static var handlesWheelScrolling_MethodID_24: jmethodID?

    override open func handlesWheelScrolling() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "handlesWheelScrolling", methodSig: "()Z", methodCache: &CheckboxPeerForward.handlesWheelScrolling_MethodID_24, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var isFocusable_MethodID_25: jmethodID?

    override open func isFocusable() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFocusable", methodSig: "()Z", methodCache: &CheckboxPeerForward.isFocusable_MethodID_25, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func isObscured() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isObscured", methodSig: "()Z", methodCache: &CheckboxPeerForward.isObscured_MethodID_26, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var isReparentSupported_MethodID_27: jmethodID?

    override open func isReparentSupported() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isReparentSupported", methodSig: "()Z", methodCache: &CheckboxPeerForward.isReparentSupported_MethodID_27, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var layout_MethodID_28: jmethodID?

    override open func layout() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "layout", methodSig: "()V", methodCache: &CheckboxPeerForward.layout_MethodID_28, args: &__args, locals: &__locals )
    }
    ...
    override open func paint( g: Graphics? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &CheckboxPeerForward.paint_MethodID_29, args: &__args, locals: &__locals )
    }
    ...
    override open func prepareImage( img: Image?, w: Int, h: Int, o: ImageObserver? ) -> Bool {
        ...
        __args[2] = jvalue( i: jint(h) )
        __args[3] = JNIType.toJava( value: o, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "prepareImage", methodSig: "(Ljava/awt/Image;IILjava/awt/image/ImageObserver;)Z", methodCache: &CheckboxPeerForward.prepareImage_MethodID_30, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func print( g: Graphics? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: g, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "print", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &CheckboxPeerForward.print_MethodID_31, args: &__args, locals: &__locals )
    }
    ...
    override open func requestFocus( lightweightChild: Component?, temporary: Bool, focusedWindowChangeAllowed: Bool, time: Int64, cause: /* class sun.awt.CausedFocusEvent$Cause */ UnavailableEnum? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "requestFocus", methodSig: "(Ljava/awt/Component;ZZJLsun/awt/CausedFocusEvent$Cause;)Z", methodCache: &CheckboxPeerForward.requestFocus_MethodID_33, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func setBackground( c: Color? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBackground", methodSig: "(Ljava/awt/Color;)V", methodCache: &CheckboxPeerForward.setBackground_MethodID_34, args: &__args, locals: &__locals )
    }
    ...
    override open func setBounds( x: Int, y: Int, width: Int, height: Int, op: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBounds", methodSig: "(IIIII)V", methodCache: &CheckboxPeerForward.setBounds_MethodID_35, args: &__args, locals: &__locals )
    }
    ...
    private static var setCheckboxGroup_MethodID_36: jmethodID?

    open func setCheckboxGroup( g: CheckboxGroup? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: g, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCheckboxGroup", methodSig: "(Ljava/awt/CheckboxGroup;)V", methodCache: &CheckboxPeerForward.setCheckboxGroup_MethodID_36, args: &__args, locals: &__locals )
    }
    ...
    override open func setEnabled( e: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setEnabled", methodSig: "(Z)V", methodCache: &CheckboxPeerForward.setEnabled_MethodID_37, args: &__args, locals: &__locals )
    }
    ...
    override open func setFont( f: Font? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setFont", methodSig: "(Ljava/awt/Font;)V", methodCache: &CheckboxPeerForward.setFont_MethodID_38, args: &__args, locals: &__locals )
    }
    ...
    override open func setForeground( c: Color? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setForeground", methodSig: "(Ljava/awt/Color;)V", methodCache: &CheckboxPeerForward.setForeground_MethodID_39, args: &__args, locals: &__locals )
    }
    ...
    private static var setLabel_MethodID_40: jmethodID?

    open func setLabel( label: String? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: label, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLabel", methodSig: "(Ljava/lang/String;)V", methodCache: &CheckboxPeerForward.setLabel_MethodID_40, args: &__args, locals: &__locals )
    }
    ...
    private static var setState_MethodID_41: jmethodID?

    open func setState( state: Bool ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( z: jboolean(state ? JNI_TRUE : JNI_FALSE) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setState", methodSig: "(Z)V", methodCache: &CheckboxPeerForward.setState_MethodID_41, args: &__args, locals: &__locals )
    }
    ...
    override open func setVisible( v: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setVisible", methodSig: "(Z)V", methodCache: &CheckboxPeerForward.setVisible_MethodID_42, args: &__args, locals: &__locals )
    }
    ...
    private static var setZOrder_MethodID_43: jmethodID?

    override open func setZOrder( above: ComponentPeer? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: above, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setZOrder", methodSig: "(Ljava/awt/peer/ComponentPeer;)V", methodCache: &CheckboxPeerForward.setZOrder_MethodID_43, args: &__args, locals: &__locals )
    }
    ...
    override open func updateCursorImmediately() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "updateCursorImmediately", methodSig: "()V", methodCache: &CheckboxPeerForward.updateCursorImmediately_MethodID_44, args: &__args, locals: &__locals )
    }
    ...
    override open func updateGraphicsData( gc: GraphicsConfiguration? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "updateGraphicsData", methodSig: "(Ljava/awt/GraphicsConfiguration;)Z", methodCache: &CheckboxPeerForward.updateGraphicsData_MethodID_45, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
