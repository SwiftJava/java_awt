...
open class EventQueue: java_swift.JavaObject {
    ...
    private static var createSecondaryLoop_MethodID_5: jmethodID?

    open func createSecondaryLoop() -> SecondaryLoop! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createSecondaryLoop", methodSig: "()Ljava/awt/SecondaryLoop;", methodCache: &EventQueue.createSecondaryLoop_MethodID_5, args: &__args, locals: &__locals )
    ...
    private static var getMostRecentEventTime_MethodID_6: jmethodID?

    open class func getMostRecentEventTime() -> Int64 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticLongMethod( className: "java/awt/EventQueue", classCache: &EventQueueJNIClass, methodName: "getMostRecentEventTime", methodSig: "()J", methodCache: &getMostRecentEventTime_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var getNextEvent_MethodID_7: jmethodID?

    open func getNextEvent() throws /* java.lang.InterruptedException */ -> AWTEvent! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getNextEvent", methodSig: "()Ljava/awt/AWTEvent;", methodCache: &EventQueue.getNextEvent_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw java_lang.InterruptedException( javaObject: throwable )
        }
    ...
    private static var peekEvent_MethodID_8: jmethodID?

    open func peekEvent() -> AWTEvent! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "peekEvent", methodSig: "()Ljava/awt/AWTEvent;", methodCache: &EventQueue.peekEvent_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? AWTEvent( javaObject: __return ) : nil
    }
    ...
    private static var dispatchEvent_MethodID_10: jmethodID?

    open func dispatchEvent( arg0: AWTEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dispatchEvent", methodSig: "(Ljava/awt/AWTEvent;)V", methodCache: &EventQueue.dispatchEvent_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var postEvent_MethodID_11: jmethodID?

    open func postEvent( arg0: AWTEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0 != nil ? arg0! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "postEvent", methodSig: "(Ljava/awt/AWTEvent;)V", methodCache: &EventQueue.postEvent_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var isDispatchThread_MethodID_12: jmethodID?

    open class func isDispatchThread() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/awt/EventQueue", classCache: &EventQueueJNIClass, methodName: "isDispatchThread", methodSig: "()Z", methodCache: &isDispatchThread_MethodID_12, args: &__args, locals: &__locals )
    ...
    private static var invokeLater_MethodID_13: jmethodID?

    open class func invokeLater( arg0: java_swift.Runnable? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallStaticVoidMethod( className: "java/awt/EventQueue", classCache: &EventQueueJNIClass, methodName: "invokeLater", methodSig: "(Ljava/lang/Runnable;)V", methodCache: &invokeLater_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var getCurrentEvent_MethodID_14: jmethodID?

    open class func getCurrentEvent() -> AWTEvent! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/EventQueue", classCache: &EventQueueJNIClass, methodName: "getCurrentEvent", methodSig: "()Ljava/awt/AWTEvent;", methodCache: &getCurrentEvent_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? AWTEvent( javaObject: __return ) : nil
    }
