...
open class DisplayMode: java_swift.JavaObject {
    ...
    public convenience init( width: Int, height: Int, bitDepth: Int, refreshRate: Int ) {
        ...
        __args[2] = jvalue( i: jint(bitDepth) )
        __args[3] = jvalue( i: jint(refreshRate) )
    ...
    open func getHeight() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getHeight", methodSig: "()I", methodCache: &DisplayMode.getHeight_MethodID_5, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func getWidth() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getWidth", methodSig: "()I", methodCache: &DisplayMode.getWidth_MethodID_7, args: &__args, locals: &__locals )
        return Int(__return)
    }
