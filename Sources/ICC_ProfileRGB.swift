...
open class ICC_ProfileRGB: ICC_Profile {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.awt.color.ICC_ProfileRGB", file, line ) {
            return nil
        }
    ...
    /// java.awt.color.ICC_ProfileRGB(long)

    /// java.awt.color.ICC_ProfileRGB(sun.awt.color.ProfileDeferralInfo)
