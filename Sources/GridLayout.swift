...
open class GridLayout: java_swift.JavaObject, LayoutManager, /* java.io.Serializable */ UnclassedProtocol {
    ...
    public convenience init( rows: Int, cols: Int, hgap: Int, vgap: Int ) {
        ...
        __args[1] = JNIType.toJava( value: cols, locals: &__locals )
        __args[2] = JNIType.toJava( value: hgap, locals: &__locals )
        __args[3] = JNIType.toJava( value: vgap, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/awt/GridLayout", classCache: &GridLayout.GridLayoutJNIClass, methodSig: "(IIII)V", methodCache: &GridLayout.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init() {
        ...
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/awt/GridLayout", classCache: &GridLayout.GridLayoutJNIClass, methodSig: "()V", methodCache: &GridLayout.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    private static var getRows_MethodID_4: jmethodID?

    open func getRows() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getRows", methodSig: "()I", methodCache: &GridLayout.getRows_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var setRows_MethodID_5: jmethodID?

    open func setRows( rows: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: rows, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setRows", methodSig: "(I)V", methodCache: &GridLayout.setRows_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var getColumns_MethodID_6: jmethodID?

    open func getColumns() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getColumns", methodSig: "()I", methodCache: &GridLayout.getColumns_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var setColumns_MethodID_7: jmethodID?

    open func setColumns( cols: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: cols, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setColumns", methodSig: "(I)V", methodCache: &GridLayout.setColumns_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func getHgap() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getHgap", methodSig: "()I", methodCache: &GridLayout.getHgap_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func setHgap( hgap: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setHgap", methodSig: "(I)V", methodCache: &GridLayout.setHgap_MethodID_9, args: &__args, locals: &__locals )
    }
    ...
    open func getVgap() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getVgap", methodSig: "()I", methodCache: &GridLayout.getVgap_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func setVgap( vgap: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setVgap", methodSig: "(I)V", methodCache: &GridLayout.setVgap_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open func addLayoutComponent( name: String?, comp: Component? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addLayoutComponent", methodSig: "(Ljava/lang/String;Ljava/awt/Component;)V", methodCache: &GridLayout.addLayoutComponent_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    open func layoutContainer( parent: Container? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "layoutContainer", methodSig: "(Ljava/awt/Container;)V", methodCache: &GridLayout.layoutContainer_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    open func preferredLayoutSize( parent: Container? ) -> Dimension! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: parent, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "preferredLayoutSize", methodSig: "(Ljava/awt/Container;)Ljava/awt/Dimension;", methodCache: &GridLayout.preferredLayoutSize_MethodID_15, args: &__args, locals: &__locals )
    ...
    private static var minimumLayoutSize_MethodID_16: jmethodID?

    open func minimumLayoutSize( parent: Container? ) -> Dimension! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: parent, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "minimumLayoutSize", methodSig: "(Ljava/awt/Container;)Ljava/awt/Dimension;", methodCache: &GridLayout.minimumLayoutSize_MethodID_16, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Dimension( javaObject: __return ) : nil
    }
