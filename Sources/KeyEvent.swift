...
open class KeyEvent: InputEvent {
    ...
    override open var consumed: Bool {
        get {
            let __value = JNIField.GetBooleanField( fieldName: "consumed", fieldType: "Z", fieldCache: &KeyEvent.consumed_FieldID, object: javaObject )
    ...
    override open var id: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "id", fieldType: "I", fieldCache: &KeyEvent.id_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var source: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &KeyEvent.source_FieldID, object: javaObject )
    ...
    public convenience init( source: Component?, id: Int, when: Int64, modifiers: Int, keyCode: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/event/KeyEvent", classCache: &KeyEvent.KeyEventJNIClass, methodSig: "(Ljava/awt/Component;IJII)V", methodCache: &KeyEvent.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _source: Component?, _ _id: Int, _ _when: Int64, _ _modifiers: Int, _ _keyCode: Int ) {
        self.init( source: _source, id: _id, when: _when, modifiers: _modifiers, keyCode: _keyCode )
    }
    ...
    public convenience init( _ _source: Component?, _ _id: Int, _ _when: Int64, _ _modifiers: Int, _ _keyCode: Int, _ _keyChar: UInt16 ) {
        self.init( source: _source, id: _id, when: _when, modifiers: _modifiers, keyCode: _keyCode, keyChar: _keyChar )
    }
    ...
    public convenience init( source: Component?, id: Int, when: Int64, modifiers: Int, keyCode: Int, keyChar: UInt16, keyLocation: Int ) {
        ...
        __args[4] = jvalue( i: jint(keyCode) )
        __args[5] = jvalue( c: keyChar )
        __args[6] = jvalue( i: jint(keyLocation) )
        let __object = JNIMethod.NewObject( className: "java/awt/event/KeyEvent", classCache: &KeyEvent.KeyEventJNIClass, methodSig: "(Ljava/awt/Component;IJIICI)V", methodCache: &KeyEvent.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _source: Component?, _ _id: Int, _ _when: Int64, _ _modifiers: Int, _ _keyCode: Int, _ _keyChar: UInt16, _ _keyLocation: Int ) {
        self.init( source: _source, id: _id, when: _when, modifiers: _modifiers, keyCode: _keyCode, keyChar: _keyChar, keyLocation: _keyLocation )
    }
    ...
    /// static long java.awt.event.KeyEvent.access$202(java.awt.event.KeyEvent,long)

    // Skipping method: true false false false false 

    /// static java.awt.Component java.awt.event.KeyEvent.access$300(java.awt.event.KeyEvent)

    // Skipping method: true false false false false 

    /// public static int java.awt.event.KeyEvent.getExtendedKeyCodeForChar(int)

    private static var getExtendedKeyCodeForChar_MethodID_4: jmethodID?

    open class func getExtendedKeyCodeForChar( c: Int ) -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(c) )
        let __return = JNIMethod.CallStaticIntMethod( className: "java/awt/event/KeyEvent", classCache: &KeyEventJNIClass, methodName: "getExtendedKeyCodeForChar", methodSig: "(I)I", methodCache: &getExtendedKeyCodeForChar_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }

    open class func getExtendedKeyCodeForChar( _ _c: Int ) -> Int {
        return getExtendedKeyCodeForChar( c: _c )
    }

    /// public static java.lang.String java.awt.event.KeyEvent.getKeyModifiersText(int)

    private static var getKeyModifiersText_MethodID_5: jmethodID?

    open class func getKeyModifiersText( modifiers: Int ) -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(modifiers) )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/event/KeyEvent", classCache: &KeyEventJNIClass, methodName: "getKeyModifiersText", methodSig: "(I)Ljava/lang/String;", methodCache: &getKeyModifiersText_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? String( javaObject: __return ) : nil
    }

    open class func getKeyModifiersText( _ _modifiers: Int ) -> String! {
        return getKeyModifiersText( modifiers: _modifiers )
    }

    /// public static java.lang.String java.awt.event.KeyEvent.getKeyText(int)

    private static var getKeyText_MethodID_6: jmethodID?

    open class func getKeyText( keyCode: Int ) -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(keyCode) )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/event/KeyEvent", classCache: &KeyEventJNIClass, methodName: "getKeyText", methodSig: "(I)Ljava/lang/String;", methodCache: &getKeyText_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? String( javaObject: __return ) : nil
    }
    ...
    private static var getExtendedKeyCode_MethodID_7: jmethodID?

    open func getExtendedKeyCode() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getExtendedKeyCode", methodSig: "()I", methodCache: &KeyEvent.getExtendedKeyCode_MethodID_7, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getKeyChar_MethodID_8: jmethodID?

    open func getKeyChar() -> UInt16 {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallCharMethod( object: javaObject, methodName: "getKeyChar", methodSig: "()C", methodCache: &KeyEvent.getKeyChar_MethodID_8, args: &__args, locals: &__locals )
        return __return
    }
    ...
    private static var getKeyCode_MethodID_9: jmethodID?

    open func getKeyCode() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getKeyCode", methodSig: "()I", methodCache: &KeyEvent.getKeyCode_MethodID_9, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var setKeyChar_MethodID_12: jmethodID?

    open func setKeyChar( keyChar: UInt16 ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( c: keyChar )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setKeyChar", methodSig: "(C)V", methodCache: &KeyEvent.setKeyChar_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var setKeyCode_MethodID_13: jmethodID?

    open func setKeyCode( keyCode: Int ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(keyCode) )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setKeyCode", methodSig: "(I)V", methodCache: &KeyEvent.setKeyCode_MethodID_13, args: &__args, locals: &__locals )
    }
