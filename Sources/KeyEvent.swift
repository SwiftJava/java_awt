...
open class KeyEvent: InputEvent {
    ...
    public convenience init( source: Component?, id: Int, when: Int64, modifiers: Int, keyCode: Int, keyChar: UInt16, keyLocation: Int ) {
        ...
        __args[6] = JNIType.toJava( value: keyLocation, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/awt/event/KeyEvent", classCache: &KeyEvent.KeyEventJNIClass, methodSig: "(Ljava/awt/Component;IJIICI)V", methodCache: &KeyEvent.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( source: Component?, id: Int, when: Int64, modifiers: Int, keyCode: Int, keyChar: UInt16 ) {
        ...
        __args[4] = JNIType.toJava( value: keyCode, locals: &__locals )
        __args[5] = JNIType.toJava( value: keyChar, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/awt/event/KeyEvent", classCache: &KeyEvent.KeyEventJNIClass, methodSig: "(Ljava/awt/Component;IJIIC)V", methodCache: &KeyEvent.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    private static var getExtendedKeyCodeForChar_MethodID_6: jmethodID?

    open class func getExtendedKeyCodeForChar( c: Int ) -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "java/awt/event/KeyEvent", classCache: &KeyEventJNIClass, methodName: "getExtendedKeyCodeForChar", methodSig: "(I)I", methodCache: &getExtendedKeyCodeForChar_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
