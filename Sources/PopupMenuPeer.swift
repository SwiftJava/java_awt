...
open class PopupMenuPeerForward: MenuPeerForward, PopupMenuPeer {
    ...
    override open func dispose() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dispose", methodSig: "()V", methodCache: &PopupMenuPeerForward.dispose_MethodID_9, args: &__args, locals: &__locals )
    }
