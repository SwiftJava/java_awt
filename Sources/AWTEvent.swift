...
open class AWTEvent: java_util.EventObject {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.awt.AWTEvent", file, line ) {
            return nil
        }
    ...
    /// private void java.awt.AWTEvent.readObject(java.io.ObjectInputStream) throws java.lang.ClassNotFoundException,java.io.IOException
    ...
    /// private static void java.awt.AWTEvent.initIDs()

    /// public int java.awt.AWTEvent.getID()

    private static var getID_MethodID_3: jmethodID?

    open func getID() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getID", methodSig: "()I", methodCache: &AWTEvent.getID_MethodID_3, args: &__args, locals: &__locals )
    ...
    open func paramString() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "paramString", methodSig: "()Ljava/lang/String;", methodCache: &AWTEvent.paramString_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func setSource( arg0: java_lang.JavaObject? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func setSource( _ _arg0: java_lang.JavaObject? ) {
