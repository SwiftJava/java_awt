...
open class LinearGradientPaint: MultipleGradientPaint {
    ...
    public convenience init( start: Point2D?, end: Point2D?, fractions: [Float]?, colors: [Color]?, cycleMethod: MultipleGradientPaint_CycleMethod?, colorSpace: MultipleGradientPaint_ColorSpaceType?, gradientTransform: AffineTransform? ) {
        ...
        __args[0] = JNIType.toJava( value: start != nil ? start! as JNIObject : nil, locals: &__locals )
        __args[1] = JNIType.toJava( value: end != nil ? end! as JNIObject : nil, locals: &__locals )
        ...
        __args[5] = JNIType.toJava( value: colorSpace != nil ? colorSpace! as JNIObject : nil, locals: &__locals )
        __args[6] = JNIType.toJava( value: gradientTransform != nil ? gradientTransform! as JNIObject : nil, locals: &__locals )
    ...
    public convenience init( startX: Float, startY: Float, endX: Float, endY: Float, fractions: [Float]?, colors: [Color]?, cycleMethod: MultipleGradientPaint_CycleMethod? ) {
        ...
        __args[6] = JNIType.toJava( value: cycleMethod != nil ? cycleMethod! as JNIObject : nil, locals: &__locals )
