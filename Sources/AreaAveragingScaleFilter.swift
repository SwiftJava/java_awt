...
open class AreaAveragingScaleFilter: ReplicateScaleFilter {
    ...
    override open var destHeight: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "destHeight", fieldType: "I", fieldCache: &AreaAveragingScaleFilter.destHeight_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
    ...
    override open var destWidth: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "destWidth", fieldType: "I", fieldCache: &AreaAveragingScaleFilter.destWidth_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var outpixbuf: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "outpixbuf", fieldType: "Ljava/lang/Object;", fieldCache: &AreaAveragingScaleFilter.outpixbuf_FieldID, object: javaObject )
    ...
    override open var srcHeight: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "srcHeight", fieldType: "I", fieldCache: &AreaAveragingScaleFilter.srcHeight_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var srcWidth: Int {
        get {
            let __value = JNIField.GetIntField( fieldName: "srcWidth", fieldType: "I", fieldCache: &AreaAveragingScaleFilter.srcWidth_FieldID, object: javaObject )
            return Int(__value)
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var srccols: [Int32]! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "srccols", fieldType: "[I", fieldCache: &AreaAveragingScaleFilter.srccols_FieldID, object: javaObject )
    ...
    override open var srcrows: [Int32]! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "srcrows", fieldType: "[I", fieldCache: &AreaAveragingScaleFilter.srcrows_FieldID, object: javaObject )
            return JNIType.toSwift( type: [Int32].self, from: __value )
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    override open var consumer: ImageConsumer! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "consumer", fieldType: "Ljava/awt/image/ImageConsumer;", fieldCache: &AreaAveragingScaleFilter.consumer_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
