...
open class InputMethodEvent: AWTEvent {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.awt.event.InputMethodEvent", file, line ) {
            return nil
        }
    ...
    public convenience init( arg0: Component?, arg1: Int, arg2: Int64, arg3: /* java.text.AttributedCharacterIterator */ UnclassedProtocol?, arg4: Int, arg5: TextHitInfo?, arg6: TextHitInfo? ) {
    ...
    public convenience init( _ _arg0: Component?, _ _arg1: Int, _ _arg2: Int64, _ _arg3: /* java.text.AttributedCharacterIterator */ UnclassedProtocol?, _ _arg4: Int, _ _arg5: TextHitInfo?, _ _arg6: TextHitInfo? ) {
    ...
    public convenience init( arg0: Component?, arg1: Int, arg2: /* java.text.AttributedCharacterIterator */ UnclassedProtocol?, arg3: Int, arg4: TextHitInfo?, arg5: TextHitInfo? ) {
    ...
    public convenience init( _ _arg0: Component?, _ _arg1: Int, _ _arg2: /* java.text.AttributedCharacterIterator */ UnclassedProtocol?, _ _arg3: Int, _ _arg4: TextHitInfo?, _ _arg5: TextHitInfo? ) {
    ...
    public convenience init( arg0: Component?, arg1: Int, arg2: TextHitInfo?, arg3: TextHitInfo? ) {
        ...
        __args[2] = JNIType.encode( value: arg2, locals: &__locals )
        __args[3] = JNIType.encode( value: arg3, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/awt/event/InputMethodEvent", classCache: &InputMethodEvent.InputMethodEventJNIClass, methodSig: "(Ljava/awt/Component;ILjava/awt/font/TextHitInfo;Ljava/awt/font/TextHitInfo;)V", methodCache: &InputMethodEvent.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _arg0: Component?, _ _arg1: Int, _ _arg2: TextHitInfo?, _ _arg3: TextHitInfo? ) {
    ...
    override open func isConsumed() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isConsumed", methodSig: "()Z", methodCache: &InputMethodEvent.isConsumed_MethodID_6, args: &__args, locals: &__locals )
    ...
    override open func consume() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "consume", methodSig: "()V", methodCache: &InputMethodEvent.consume_MethodID_7, args: &__args, locals: &__locals )
    }


    /// public int java.awt.event.InputMethodEvent.getCommittedCharacterCount()

    private static var getCommittedCharacterCount_MethodID_8: jmethodID?

    open func getCommittedCharacterCount() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getCommittedCharacterCount", methodSig: "()I", methodCache: &InputMethodEvent.getCommittedCharacterCount_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var getCaret_MethodID_9: jmethodID?

    open func getCaret() -> TextHitInfo! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getCaret", methodSig: "()Ljava/awt/font/TextHitInfo;", methodCache: &InputMethodEvent.getCaret_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getVisiblePosition_MethodID_10: jmethodID?

    open func getVisiblePosition() -> TextHitInfo! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getVisiblePosition", methodSig: "()Ljava/awt/font/TextHitInfo;", methodCache: &InputMethodEvent.getVisiblePosition_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? TextHitInfo( javaObject: __return ) : nil
    }
