...
open class DragSource: java_swift.JavaObject, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var startDrag_MethodID_2: jmethodID?
    ...
    open func startDrag( trigger: DragGestureEvent?, dragCursor: Cursor?, dragImage: Image?, dragOffset: Point?, transferable: Transferable?, dsl: DragSourceListener? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startDrag", methodSig: "(Ljava/awt/dnd/DragGestureEvent;Ljava/awt/Cursor;Ljava/awt/Image;Ljava/awt/Point;Ljava/awt/datatransfer/Transferable;Ljava/awt/dnd/DragSourceListener;)V", methodCache: &DragSource.startDrag_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var startDrag_MethodID_3: jmethodID?
    ...
    open func startDrag( trigger: DragGestureEvent?, dragCursor: Cursor?, transferable: Transferable?, dsl: DragSourceListener? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startDrag", methodSig: "(Ljava/awt/dnd/DragGestureEvent;Ljava/awt/Cursor;Ljava/awt/datatransfer/Transferable;Ljava/awt/dnd/DragSourceListener;)V", methodCache: &DragSource.startDrag_MethodID_3, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw InvalidDnDOperationException( javaObject: throwable )
        }
    }
    ...
    private static var startDrag_MethodID_4: jmethodID?
    ...
    open func startDrag( trigger: DragGestureEvent?, dragCursor: Cursor?, transferable: Transferable?, dsl: DragSourceListener?, flavorMap: FlavorMap? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startDrag", methodSig: "(Ljava/awt/dnd/DragGestureEvent;Ljava/awt/Cursor;Ljava/awt/datatransfer/Transferable;Ljava/awt/dnd/DragSourceListener;Ljava/awt/datatransfer/FlavorMap;)V", methodCache: &DragSource.startDrag_MethodID_5, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw InvalidDnDOperationException( javaObject: throwable )
        }
    }
    ...
    private static var getDefaultDragSource_MethodID_6: jmethodID?

    open class func getDefaultDragSource() -> DragSource! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/dnd/DragSource", classCache: &DragSourceJNIClass, methodName: "getDefaultDragSource", methodSig: "()Ljava/awt/dnd/DragSource;", methodCache: &getDefaultDragSource_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var isDragImageSupported_MethodID_7: jmethodID?

    open class func isDragImageSupported() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticBooleanMethod( className: "java/awt/dnd/DragSource", classCache: &DragSourceJNIClass, methodName: "isDragImageSupported", methodSig: "()Z", methodCache: &isDragImageSupported_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var createDragSourceContext_MethodID_8: jmethodID?
    ...
    private static var createDefaultDragGestureRecognizer_MethodID_9: jmethodID?
    ...
    private static var addDragSourceListener_MethodID_10: jmethodID?

    open func addDragSourceListener( dsl: DragSourceListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dsl, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addDragSourceListener", methodSig: "(Ljava/awt/dnd/DragSourceListener;)V", methodCache: &DragSource.addDragSourceListener_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var removeDragSourceListener_MethodID_11: jmethodID?

    open func removeDragSourceListener( dsl: DragSourceListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dsl, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeDragSourceListener", methodSig: "(Ljava/awt/dnd/DragSourceListener;)V", methodCache: &DragSource.removeDragSourceListener_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var getDragSourceListeners_MethodID_12: jmethodID?

    open func getDragSourceListeners() -> [DragSourceListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDragSourceListeners", methodSig: "()[Ljava/awt/dnd/DragSourceListener;", methodCache: &DragSource.getDragSourceListeners_MethodID_12, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [DragSourceListenerForward](), from: __return )
    }


    /// public void java.awt.dnd.DragSource.addDragSourceMotionListener(java.awt.dnd.DragSourceMotionListener)

    private static var addDragSourceMotionListener_MethodID_13: jmethodID?

    open func addDragSourceMotionListener( dsml: DragSourceMotionListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dsml, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addDragSourceMotionListener", methodSig: "(Ljava/awt/dnd/DragSourceMotionListener;)V", methodCache: &DragSource.addDragSourceMotionListener_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var removeDragSourceMotionListener_MethodID_14: jmethodID?

    open func removeDragSourceMotionListener( dsml: DragSourceMotionListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: dsml, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeDragSourceMotionListener", methodSig: "(Ljava/awt/dnd/DragSourceMotionListener;)V", methodCache: &DragSource.removeDragSourceMotionListener_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var getDragSourceMotionListeners_MethodID_15: jmethodID?

    open func getDragSourceMotionListeners() -> [DragSourceMotionListener]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDragSourceMotionListeners", methodSig: "()[Ljava/awt/dnd/DragSourceMotionListener;", methodCache: &DragSource.getDragSourceMotionListeners_MethodID_15, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [DragSourceMotionListenerForward](), from: __return )
    }
    ...
    private static var getDragThreshold_MethodID_16: jmethodID?

    open class func getDragThreshold() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticIntMethod( className: "java/awt/dnd/DragSource", classCache: &DragSourceJNIClass, methodName: "getDragThreshold", methodSig: "()I", methodCache: &getDragThreshold_MethodID_16, args: &__args, locals: &__locals )
    ...
    open func getFlavorMap() -> FlavorMap! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFlavorMap", methodSig: "()Ljava/awt/datatransfer/FlavorMap;", methodCache: &DragSource.getFlavorMap_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getListeners( listenerType: java_swift.JavaClass? ) -> [EventListener]! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getListeners", methodSig: "(Ljava/lang/Class;)[Ljava/util/EventListener;", methodCache: &DragSource.getListeners_MethodID_18, args: &__args, locals: &__locals )
