...
open class DragSource: java_swift.JavaObject, /* java.io.Serializable */ UnclassedProtocol {
    ...
    open func createDragGestureRecognizer( recognizerAbstractClass: java_swift.JavaClass?, c: Component?, actions: Int, dgl: DragGestureListener? ) -> DragGestureRecognizer! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: recognizerAbstractClass != nil ? recognizerAbstractClass! as JNIObject : nil, locals: &__locals )
    ...
    private static var getFlavorMap_MethodID_3: jmethodID?

    open func getFlavorMap() -> FlavorMap! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFlavorMap", methodSig: "()Ljava/awt/datatransfer/FlavorMap;", methodCache: &DragSource.getFlavorMap_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getListeners( listenerType: java_swift.JavaClass? ) -> [EventListener]! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getListeners", methodSig: "(Ljava/lang/Class;)[Ljava/util/EventListener;", methodCache: &DragSource.getListeners_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func startDrag( trigger: DragGestureEvent?, dragCursor: Cursor?, transferable: Transferable?, dsl: DragSourceListener?, flavorMap: FlavorMap? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: trigger != nil ? trigger! as JNIObject : nil, locals: &__locals )
        __args[1] = JNIType.toJava( value: dragCursor != nil ? dragCursor! as JNIObject : nil, locals: &__locals )
    ...
    open func startDrag( trigger: DragGestureEvent?, dragCursor: Cursor?, dragImage: Image?, dragOffset: Point?, transferable: Transferable?, dsl: DragSourceListener? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        __args[3] = JNIType.toJava( value: dragOffset != nil ? dragOffset! as JNIObject : nil, locals: &__locals )
    ...
    open func startDrag( trigger: DragGestureEvent?, dragCursor: Cursor?, transferable: Transferable?, dsl: DragSourceListener? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        __args[2] = JNIType.toJava( value: transferable, locals: &__locals )
        __args[3] = JNIType.toJava( value: dsl, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startDrag", methodSig: "(Ljava/awt/dnd/DragGestureEvent;Ljava/awt/Cursor;Ljava/awt/datatransfer/Transferable;Ljava/awt/dnd/DragSourceListener;)V", methodCache: &DragSource.startDrag_MethodID_7, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw InvalidDnDOperationException( javaObject: throwable )
        }
    }
    ...
    open func createDragSourceContext( dscp: DragSourceContextPeer?, dgl: DragGestureEvent?, dragCursor: Cursor?, dragImage: Image?, imageOffset: Point?, t: Transferable?, dsl: DragSourceListener? ) -> DragSourceContext! {
        ...
        __args[1] = JNIType.toJava( value: dgl != nil ? dgl! as JNIObject : nil, locals: &__locals )
        ...
        __args[4] = JNIType.toJava( value: imageOffset != nil ? imageOffset! as JNIObject : nil, locals: &__locals )
