...
open class UnsupportedFlavorException: java_lang.Exception {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.datatransfer.UnsupportedFlavorException", file, line ) {
            return nil
        }
    ...
    public convenience init( arg0: DataFlavor? ) {
    ...
    public convenience init( _ _arg0: DataFlavor? ) {
