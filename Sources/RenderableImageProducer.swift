...
open class RenderableImageProducer: java_swift.JavaObject, ImageProducer, java_swift.Runnable {
    ...
    private static var setRenderContext_MethodID_3: jmethodID?

    open func setRenderContext( rc: RenderContext? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: rc, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setRenderContext", methodSig: "(Ljava/awt/image/renderable/RenderContext;)V", methodCache: &RenderableImageProducer.setRenderContext_MethodID_3, args: &__args, locals: &__locals )
    }
    ...
    private static var addConsumer_MethodID_4: jmethodID?

    open func addConsumer( ic: ImageConsumer? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: ic, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addConsumer", methodSig: "(Ljava/awt/image/ImageConsumer;)V", methodCache: &RenderableImageProducer.addConsumer_MethodID_4, args: &__args, locals: &__locals )
    }
    ...
    private static var isConsumer_MethodID_5: jmethodID?

    open func isConsumer( ic: ImageConsumer? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: ic, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isConsumer", methodSig: "(Ljava/awt/image/ImageConsumer;)Z", methodCache: &RenderableImageProducer.isConsumer_MethodID_5, args: &__args, locals: &__locals )
    ...
    private static var removeConsumer_MethodID_6: jmethodID?

    open func removeConsumer( ic: ImageConsumer? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: ic, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeConsumer", methodSig: "(Ljava/awt/image/ImageConsumer;)V", methodCache: &RenderableImageProducer.removeConsumer_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var startProduction_MethodID_7: jmethodID?

    open func startProduction( ic: ImageConsumer? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: ic, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startProduction", methodSig: "(Ljava/awt/image/ImageConsumer;)V", methodCache: &RenderableImageProducer.startProduction_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var requestTopDownLeftRightResend_MethodID_8: jmethodID?

    open func requestTopDownLeftRightResend( ic: ImageConsumer? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: ic, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "requestTopDownLeftRightResend", methodSig: "(Ljava/awt/image/ImageConsumer;)V", methodCache: &RenderableImageProducer.requestTopDownLeftRightResend_MethodID_8, args: &__args, locals: &__locals )
    }
