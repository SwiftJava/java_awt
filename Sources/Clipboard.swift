...
open class Clipboard: java_swift.JavaObject {
    ...
    open var contents: Transferable! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "contents", fieldType: "Ljava/awt/datatransfer/Transferable;", fieldCache: &Clipboard.contents_FieldID, object: javaObject )
    ...
    open var owner: ClipboardOwner! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "owner", fieldType: "Ljava/awt/datatransfer/ClipboardOwner;", fieldCache: &Clipboard.owner_FieldID, object: javaObject )
            defer { JNI.DeleteLocalRef( __value ) }
    ...
    private static var addFlavorListener_MethodID_2: jmethodID?

    open func addFlavorListener( listener: FlavorListener? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: listener, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addFlavorListener", methodSig: "(Ljava/awt/datatransfer/FlavorListener;)V", methodCache: &Clipboard.addFlavorListener_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    private static var getAvailableDataFlavors_MethodID_3: jmethodID?

    open func getAvailableDataFlavors() -> [DataFlavor]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAvailableDataFlavors", methodSig: "()[Ljava/awt/datatransfer/DataFlavor;", methodCache: &Clipboard.getAvailableDataFlavors_MethodID_3, args: &__args, locals: &__locals )
    ...
    open func getData( flavor: DataFlavor? ) throws /* java.awt.datatransfer.UnsupportedFlavorException, java.io.IOException */ -> java_swift.JavaObject! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getData", methodSig: "(Ljava/awt/datatransfer/DataFlavor;)Ljava/lang/Object;", methodCache: &Clipboard.getData_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getFlavorListeners_MethodID_6: jmethodID?

    open func getFlavorListeners() -> [FlavorListener]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFlavorListeners", methodSig: "()[Ljava/awt/datatransfer/FlavorListener;", methodCache: &Clipboard.getFlavorListeners_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [FlavorListenerForward].self, from: __return )
    }
    ...
    open func getName() -> String! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getName", methodSig: "()Ljava/lang/String;", methodCache: &Clipboard.getName_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var isDataFlavorAvailable_MethodID_8: jmethodID?

    open func isDataFlavorAvailable( flavor: DataFlavor? ) -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: flavor, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isDataFlavorAvailable", methodSig: "(Ljava/awt/datatransfer/DataFlavor;)Z", methodCache: &Clipboard.isDataFlavorAvailable_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var setContents_MethodID_10: jmethodID?
    ...
    open func setContents( contents: Transferable?, owner: ClipboardOwner? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setContents", methodSig: "(Ljava/awt/datatransfer/Transferable;Ljava/awt/datatransfer/ClipboardOwner;)V", methodCache: &Clipboard.setContents_MethodID_10, args: &__args, locals: &__locals )
    }
