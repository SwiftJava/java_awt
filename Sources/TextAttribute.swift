...
open class TextAttribute: /* java.text.AttributedCharacterIterator$Attribute */ UnclassedObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.font.TextAttribute", file, line ) {
            return nil
        }
    ...
    open static var WEIGHT_EXTRA_LIGHT: Float! {
        get {
            ...
            return JNIType.decodeFloat( from: __value )
        }
    }
    ...
    open func readResolve() throws /* java.io.InvalidObjectException */ -> java_lang.JavaObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        ...
        if let throwable = JNI.ExceptionCheck() {
            throw /* java.io.InvalidObjectException */ UnclassedObject( javaObject: throwable )
        }
