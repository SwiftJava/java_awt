...
open class CompositeContextForward: JNIObjectForward, CompositeContext {
    ...
    open func compose( src: Raster?, dstIn: Raster?, dstOut: WritableRaster? ) {
        ...
        __args[1] = JNIType.toJava( value: dstIn != nil ? dstIn! as JNIObject : nil, locals: &__locals )
        __args[2] = JNIType.toJava( value: dstOut != nil ? dstOut! as JNIObject : nil, locals: &__locals )
