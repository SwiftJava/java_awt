...
open class LayoutManager2Forward: LayoutManagerForward, LayoutManager2 {
    ...
    override open func addLayoutComponent( name: String?, comp: Component? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addLayoutComponent", methodSig: "(Ljava/lang/String;Ljava/awt/Component;)V", methodCache: &LayoutManager2Forward.addLayoutComponent_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    private static var getLayoutAlignmentX_MethodID_8: jmethodID?

    open func getLayoutAlignmentX( target: Container? ) -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: target, locals: &__locals )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getLayoutAlignmentX", methodSig: "(Ljava/awt/Container;)F", methodCache: &LayoutManager2Forward.getLayoutAlignmentX_MethodID_8, args: &__args, locals: &__locals )
        return __return
    }
    ...
    private static var getLayoutAlignmentY_MethodID_9: jmethodID?

    open func getLayoutAlignmentY( target: Container? ) -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: target, locals: &__locals )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getLayoutAlignmentY", methodSig: "(Ljava/awt/Container;)F", methodCache: &LayoutManager2Forward.getLayoutAlignmentY_MethodID_9, args: &__args, locals: &__locals )
        return __return
    }
    ...
    open func invalidateLayout( target: Container? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: target, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "invalidateLayout", methodSig: "(Ljava/awt/Container;)V", methodCache: &LayoutManager2Forward.invalidateLayout_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    override open func layoutContainer( parent: Container? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "layoutContainer", methodSig: "(Ljava/awt/Container;)V", methodCache: &LayoutManager2Forward.layoutContainer_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    open func maximumLayoutSize( target: Container? ) -> Dimension! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: target, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "maximumLayoutSize", methodSig: "(Ljava/awt/Container;)Ljava/awt/Dimension;", methodCache: &LayoutManager2Forward.maximumLayoutSize_MethodID_12, args: &__args, locals: &__locals )
    ...
    override open func minimumLayoutSize( parent: Container? ) -> Dimension! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: parent, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "minimumLayoutSize", methodSig: "(Ljava/awt/Container;)Ljava/awt/Dimension;", methodCache: &LayoutManager2Forward.minimumLayoutSize_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Dimension( javaObject: __return ) : nil
    }
    ...
    override open func removeLayoutComponent( comp: Component? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: comp, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "removeLayoutComponent", methodSig: "(Ljava/awt/Component;)V", methodCache: &LayoutManager2Forward.removeLayoutComponent_MethodID_15, args: &__args, locals: &__locals )
    }
