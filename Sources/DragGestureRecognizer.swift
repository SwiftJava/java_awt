...
open class DragGestureRecognizer: java_swift.JavaObject, /* java.io.Serializable */ UnclassedProtocol {
    ...
    private static var getDragSource_MethodID_5: jmethodID?

    open func getDragSource() -> DragSource! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDragSource", methodSig: "()Ljava/awt/dnd/DragSource;", methodCache: &DragGestureRecognizer.getDragSource_MethodID_5, args: &__args, locals: &__locals )
    ...
    private static var getTriggerEvent_MethodID_6: jmethodID?

    open func getTriggerEvent() -> InputEvent! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTriggerEvent", methodSig: "()Ljava/awt/event/InputEvent;", methodCache: &DragGestureRecognizer.getTriggerEvent_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var registerListeners_MethodID_7: jmethodID?

    open func registerListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "registerListeners", methodSig: "()V", methodCache: &DragGestureRecognizer.registerListeners_MethodID_7, args: &__args, locals: &__locals )
    }


    /// protected abstract void java.awt.dnd.DragGestureRecognizer.unregisterListeners()

    private static var unregisterListeners_MethodID_8: jmethodID?

    open func unregisterListeners() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "unregisterListeners", methodSig: "()V", methodCache: &DragGestureRecognizer.unregisterListeners_MethodID_8, args: &__args, locals: &__locals )
    }
    ...
    open func getSourceActions() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getSourceActions", methodSig: "()I", methodCache: &DragGestureRecognizer.getSourceActions_MethodID_9, args: &__args, locals: &__locals )
    ...
    private static var setSourceActions_MethodID_10: jmethodID?

    open func setSourceActions( actions: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: actions, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setSourceActions", methodSig: "(I)V", methodCache: &DragGestureRecognizer.setSourceActions_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    private static var resetRecognizer_MethodID_11: jmethodID?

    open func resetRecognizer() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "resetRecognizer", methodSig: "()V", methodCache: &DragGestureRecognizer.resetRecognizer_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    private static var addDragGestureListener_MethodID_12: jmethodID?
    ...
    open func addDragGestureListener( dgl: DragGestureListener? ) throws /* java.util.TooManyListenersException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "addDragGestureListener", methodSig: "(Ljava/awt/dnd/DragGestureListener;)V", methodCache: &DragGestureRecognizer.addDragGestureListener_MethodID_12, args: &__args, locals: &__locals )
    ...
    private static var fireDragGestureRecognized_MethodID_14: jmethodID?
    ...
    open func fireDragGestureRecognized( dragAction: Int, p: Point? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "fireDragGestureRecognized", methodSig: "(ILjava/awt/Point;)V", methodCache: &DragGestureRecognizer.fireDragGestureRecognized_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var appendEvent_MethodID_15: jmethodID?

    open func appendEvent( awtie: InputEvent? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: awtie, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "appendEvent", methodSig: "(Ljava/awt/event/InputEvent;)V", methodCache: &DragGestureRecognizer.appendEvent_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    open func getComponent() -> Component! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getComponent", methodSig: "()Ljava/awt/Component;", methodCache: &DragGestureRecognizer.getComponent_MethodID_16, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var setComponent_MethodID_17: jmethodID?

    open func setComponent( c: Component? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setComponent", methodSig: "(Ljava/awt/Component;)V", methodCache: &DragGestureRecognizer.setComponent_MethodID_17, args: &__args, locals: &__locals )
    }
