...
open class LineBreakMeasurer: java_swift.JavaObject {
    ...
    public convenience init( text: /* java.text.AttributedCharacterIterator */ UnclassedProtocol?, breakIter: /* java.text.BreakIterator */ UnclassedObject?, frc: FontRenderContext? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        __args[1] = JNIType.toJava( value: breakIter != nil ? breakIter! as JNIObject : nil, locals: &__locals )
    ...
    private static var nextLayout_MethodID_3: jmethodID?

    open func nextLayout( wrappingWidth: Float ) -> TextLayout! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: wrappingWidth, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "nextLayout", methodSig: "(F)Ljava/awt/font/TextLayout;", methodCache: &LineBreakMeasurer.nextLayout_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var setPosition_MethodID_5: jmethodID?

    open func setPosition( newPosition: Int ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: newPosition, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setPosition", methodSig: "(I)V", methodCache: &LineBreakMeasurer.setPosition_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var insertChar_MethodID_6: jmethodID?
    ...
    open func insertChar( newParagraph: /* java.text.AttributedCharacterIterator */ UnclassedProtocol?, insertPos: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "insertChar", methodSig: "(Ljava/text/AttributedCharacterIterator;I)V", methodCache: &LineBreakMeasurer.insertChar_MethodID_6, args: &__args, locals: &__locals )
    }
    ...
    private static var deleteChar_MethodID_7: jmethodID?
    ...
    open func deleteChar( newParagraph: /* java.text.AttributedCharacterIterator */ UnclassedProtocol?, deletePos: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "deleteChar", methodSig: "(Ljava/text/AttributedCharacterIterator;I)V", methodCache: &LineBreakMeasurer.deleteChar_MethodID_7, args: &__args, locals: &__locals )
    }
    ...
    open func getPosition() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getPosition", methodSig: "()I", methodCache: &LineBreakMeasurer.getPosition_MethodID_8, args: &__args, locals: &__locals )
