...
private typealias DragSourceListener_dragEnter_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func DragSourceListener_dragEnter_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ dsde: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias DragSourceListener_dragOver_1_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func DragSourceListener_dragOver_1( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ dsde: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias DragSourceListener_dropActionChanged_2_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func DragSourceListener_dropActionChanged_2( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ dsde: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias DragSourceListener_dragExit_3_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func DragSourceListener_dragExit_3( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ dse: jobject? ) -> () {
    JNI.inNative = true;
...
private typealias DragSourceListener_dragDropEnd_4_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jlong, _: jobject? ) -> ()

private func DragSourceListener_dragDropEnd_4( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ __swiftObject: jlong, _ dsde: jobject? ) -> () {
    JNI.inNative = true;
...
fileprivate class DragSourceListenerLocal_: JNILocalProxy<DragSourceListener, Any> {
    ...
    fileprivate static let _proxyClass: jclass = {
        ...
        natives.append( JNINativeMethod( name: strdup("__dragEnter"), signature: strdup("(JLjava/awt/dnd/DragSourceDragEvent;)V"), fnPtr: unsafeBitCast( DragSourceListener_dragEnter_0_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let DragSourceListener_dragOver_1_thunk: DragSourceListener_dragOver_1_type = DragSourceListener_dragOver_1
        natives.append( JNINativeMethod( name: strdup("__dragOver"), signature: strdup("(JLjava/awt/dnd/DragSourceDragEvent;)V"), fnPtr: unsafeBitCast( DragSourceListener_dragOver_1_thunk, to: UnsafeMutableRawPointer.self ) ) )
        ...
        natives.append( JNINativeMethod( name: strdup("__dropActionChanged"), signature: strdup("(JLjava/awt/dnd/DragSourceDragEvent;)V"), fnPtr: unsafeBitCast( DragSourceListener_dropActionChanged_2_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let DragSourceListener_dragExit_3_thunk: DragSourceListener_dragExit_3_type = DragSourceListener_dragExit_3
        natives.append( JNINativeMethod( name: strdup("__dragExit"), signature: strdup("(JLjava/awt/dnd/DragSourceEvent;)V"), fnPtr: unsafeBitCast( DragSourceListener_dragExit_3_thunk, to: UnsafeMutableRawPointer.self ) ) )

        let DragSourceListener_dragDropEnd_4_thunk: DragSourceListener_dragDropEnd_4_type = DragSourceListener_dragDropEnd_4
        natives.append( JNINativeMethod( name: strdup("__dragDropEnd"), signature: strdup("(JLjava/awt/dnd/DragSourceDropEvent;)V"), fnPtr: unsafeBitCast( DragSourceListener_dragDropEnd_4_thunk, to: UnsafeMutableRawPointer.self ) ) )
