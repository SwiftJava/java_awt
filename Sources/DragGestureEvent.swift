...
open class DragGestureEvent: java_util.EventObject {
    ...
    override open var source: java_swift.JavaObject! {
        get {
            let __value = JNIField.GetObjectField( fieldName: "source", fieldType: "Ljava/lang/Object;", fieldCache: &DragGestureEvent.source_FieldID, object: javaObject )
    ...
    open func getComponent() -> Component! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getComponent", methodSig: "()Ljava/awt/Component;", methodCache: &DragGestureEvent.getComponent_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var getDragAction_MethodID_3: jmethodID?

    open func getDragAction() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getDragAction", methodSig: "()I", methodCache: &DragGestureEvent.getDragAction_MethodID_3, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getDragOrigin_MethodID_4: jmethodID?

    open func getDragOrigin() -> Point! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDragOrigin", methodSig: "()Ljava/awt/Point;", methodCache: &DragGestureEvent.getDragOrigin_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getDragSource() -> DragSource! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDragSource", methodSig: "()Ljava/awt/dnd/DragSource;", methodCache: &DragGestureEvent.getDragSource_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getTriggerEvent_MethodID_7: jmethodID?

    open func getTriggerEvent() -> InputEvent! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTriggerEvent", methodSig: "()Ljava/awt/event/InputEvent;", methodCache: &DragGestureEvent.getTriggerEvent_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func iterator() -> java_util.Iterator! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "iterator", methodSig: "()Ljava/util/Iterator;", methodCache: &DragGestureEvent.iterator_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var startDrag_MethodID_9: jmethodID?
    ...
    open func startDrag( dragCursor: Cursor?, dragImage: Image?, imageOffset: Point?, transferable: Transferable?, dsl: DragSourceListener? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startDrag", methodSig: "(Ljava/awt/Cursor;Ljava/awt/Image;Ljava/awt/Point;Ljava/awt/datatransfer/Transferable;Ljava/awt/dnd/DragSourceListener;)V", methodCache: &DragGestureEvent.startDrag_MethodID_9, args: &__args, locals: &__locals )
    ...
    open func startDrag( dragCursor: Cursor?, transferable: Transferable? ) throws /* java.awt.dnd.InvalidDnDOperationException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "startDrag", methodSig: "(Ljava/awt/Cursor;Ljava/awt/datatransfer/Transferable;)V", methodCache: &DragGestureEvent.startDrag_MethodID_10, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw InvalidDnDOperationException( javaObject: throwable )
        }
    ...
    open func toArray( array: [JavaObject]? ) -> [JavaObject]! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "toArray", methodSig: "([Ljava/lang/Object;)[Ljava/lang/Object;", methodCache: &DragGestureEvent.toArray_MethodID_12, args: &__args, locals: &__locals )
    ...
    open func toArray() -> [JavaObject]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "toArray", methodSig: "()[Ljava/lang/Object;", methodCache: &DragGestureEvent.toArray_MethodID_13, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [JavaObject].self, from: __return )
    }
