...
open class ColorSpace: java_swift.JavaObject, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    open class func getInstance( arg0: Int ) -> ColorSpace! {
        ...
        __args[0] = jvalue( i: jint(arg0) )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/color/ColorSpace", classCache: &ColorSpaceJNIClass, methodName: "getInstance", methodSig: "(I)Ljava/awt/color/ColorSpace;", methodCache: &getInstance_MethodID_2, args: &__args, locals: &__locals )
    ...
    private static var fromCIEXYZ_MethodID_3: jmethodID?

    open func fromCIEXYZ( arg0: [Float]? ) -> [Float]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "fromCIEXYZ", methodSig: "([F)[F", methodCache: &ColorSpace.fromCIEXYZ_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var fromRGB_MethodID_4: jmethodID?

    open func fromRGB( arg0: [Float]? ) -> [Float]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "fromRGB", methodSig: "([F)[F", methodCache: &ColorSpace.fromRGB_MethodID_4, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [Float].self, from: __return )
    }
    ...
    private static var getMaxValue_MethodID_5: jmethodID?

    open func getMaxValue( arg0: Int ) -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(arg0) )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMaxValue", methodSig: "(I)F", methodCache: &ColorSpace.getMaxValue_MethodID_5, args: &__args, locals: &__locals )
        return __return
    }
    ...
    private static var getMinValue_MethodID_6: jmethodID?

    open func getMinValue( arg0: Int ) -> Float {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(arg0) )
        let __return = JNIMethod.CallFloatMethod( object: javaObject, methodName: "getMinValue", methodSig: "(I)F", methodCache: &ColorSpace.getMinValue_MethodID_6, args: &__args, locals: &__locals )
        return __return
    }
    ...
    open func getName( arg0: Int ) -> String! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(arg0) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getName", methodSig: "(I)Ljava/lang/String;", methodCache: &ColorSpace.getName_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getNumComponents_MethodID_8: jmethodID?

    open func getNumComponents() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getNumComponents", methodSig: "()I", methodCache: &ColorSpace.getNumComponents_MethodID_8, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func getType() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getType", methodSig: "()I", methodCache: &ColorSpace.getType_MethodID_9, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var isCS_sRGB_MethodID_10: jmethodID?

    open func isCS_sRGB() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isCS_sRGB", methodSig: "()Z", methodCache: &ColorSpace.isCS_sRGB_MethodID_10, args: &__args, locals: &__locals )
    ...
    private static var toRGB_MethodID_12: jmethodID?

    open func toRGB( arg0: [Float]? ) -> [Float]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "toRGB", methodSig: "([F)[F", methodCache: &ColorSpace.toRGB_MethodID_12, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [Float].self, from: __return )
    }
