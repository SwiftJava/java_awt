...
open class MultipleGradientPaint: java_lang.JavaObject, Paint {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.MultipleGradientPaint", file, line ) {
            return nil
        }
    ...
    open func getTransparency() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getTransparency", methodSig: "()I", methodCache: &MultipleGradientPaint.getTransparency_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func getTransform() -> AffineTransform! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getTransform", methodSig: "()Ljava/awt/geom/AffineTransform;", methodCache: &MultipleGradientPaint.getTransform_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getColors_MethodID_5: jmethodID?

    open func getColors() -> [Color]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColors", methodSig: "()[Ljava/awt/Color;", methodCache: &MultipleGradientPaint.getColors_MethodID_5, args: &__args, locals: &__locals )
        return JNIType.decode( type: [Color](), from: __return )
    }


    /// public final java.awt.MultipleGradientPaint$CycleMethod java.awt.MultipleGradientPaint.getCycleMethod()

    private static var getCycleMethod_MethodID_6: jmethodID?

    open func getCycleMethod() -> MultipleGradientPaint_CycleMethod! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getCycleMethod", methodSig: "()Ljava/awt/MultipleGradientPaint$CycleMethod;", methodCache: &MultipleGradientPaint.getCycleMethod_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
