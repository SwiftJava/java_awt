...
open class ButtonPeerForward: ComponentPeerForward, ButtonPeer {
    ...
    private static var applyShape_MethodID_2: jmethodID?
    ...
    override open func applyShape( shape: /* class sun.java2d.pipe.Region */ UnavailableObject? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "applyShape", methodSig: "(Lsun/java2d/pipe/Region;)V", methodCache: &ButtonPeerForward.applyShape_MethodID_2, args: &__args, locals: &__locals )
    }
    ...
    private static var canDetermineObscurity_MethodID_3: jmethodID?

    override open func canDetermineObscurity() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "canDetermineObscurity", methodSig: "()Z", methodCache: &ButtonPeerForward.canDetermineObscurity_MethodID_3, args: &__args, locals: &__locals )
    ...
    private static var checkImage_MethodID_4: jmethodID?
    ...
    override open func checkImage( img: Image?, w: Int, h: Int, o: ImageObserver? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "checkImage", methodSig: "(Ljava/awt/Image;IILjava/awt/image/ImageObserver;)I", methodCache: &ButtonPeerForward.checkImage_MethodID_4, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var coalescePaintEvent_MethodID_5: jmethodID?

    override open func coalescePaintEvent( e: PaintEvent? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "coalescePaintEvent", methodSig: "(Ljava/awt/event/PaintEvent;)V", methodCache: &ButtonPeerForward.coalescePaintEvent_MethodID_5, args: &__args, locals: &__locals )
    }
    ...
    private static var createBuffers_MethodID_6: jmethodID?
    ...
    override open func createBuffers( numBuffers: Int, caps: BufferCapabilities? ) throws /* java.awt.AWTException */ {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "createBuffers", methodSig: "(ILjava/awt/BufferCapabilities;)V", methodCache: &ButtonPeerForward.createBuffers_MethodID_6, args: &__args, locals: &__locals )
    ...
    override open func createImage( producer: ImageProducer? ) -> Image! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createImage", methodSig: "(Ljava/awt/image/ImageProducer;)Ljava/awt/Image;", methodCache: &ButtonPeerForward.createImage_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var createVolatileImage_MethodID_9: jmethodID?
    ...
    override open func createVolatileImage( width: Int, height: Int ) -> VolatileImage! {
        ...
        __args[0] = jvalue( i: jint(width) )
        __args[1] = jvalue( i: jint(height) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createVolatileImage", methodSig: "(II)Ljava/awt/image/VolatileImage;", methodCache: &ButtonPeerForward.createVolatileImage_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var destroyBuffers_MethodID_10: jmethodID?

    override open func destroyBuffers() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "destroyBuffers", methodSig: "()V", methodCache: &ButtonPeerForward.destroyBuffers_MethodID_10, args: &__args, locals: &__locals )
    }
    ...
    override open func dispose() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dispose", methodSig: "()V", methodCache: &ButtonPeerForward.dispose_MethodID_11, args: &__args, locals: &__locals )
    }
    ...
    override open func flip( x1: Int, y1: Int, x2: Int, y2: Int, flipAction: BufferCapabilities_FlipContents? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "flip", methodSig: "(IIIILjava/awt/BufferCapabilities$FlipContents;)V", methodCache: &ButtonPeerForward.flip_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    override open func getColorModel() -> ColorModel! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColorModel", methodSig: "()Ljava/awt/image/ColorModel;", methodCache: &ButtonPeerForward.getColorModel_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getGraphics() -> Graphics! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getGraphics", methodSig: "()Ljava/awt/Graphics;", methodCache: &ButtonPeerForward.getGraphics_MethodID_16, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getGraphicsConfiguration_MethodID_17: jmethodID?

    override open func getGraphicsConfiguration() -> GraphicsConfiguration! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getGraphicsConfiguration", methodSig: "()Ljava/awt/GraphicsConfiguration;", methodCache: &ButtonPeerForward.getGraphicsConfiguration_MethodID_17, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getLocationOnScreen_MethodID_18: jmethodID?

    override open func getLocationOnScreen() -> Point! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getLocationOnScreen", methodSig: "()Ljava/awt/Point;", methodCache: &ButtonPeerForward.getLocationOnScreen_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getMinimumSize() -> Dimension! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getMinimumSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &ButtonPeerForward.getMinimumSize_MethodID_19, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    override open func getPreferredSize() -> Dimension! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPreferredSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &ButtonPeerForward.getPreferredSize_MethodID_20, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Dimension( javaObject: __return ) : nil
    }
    ...
    override open func handleEvent( e: AWTEvent? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: e, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "handleEvent", methodSig: "(Ljava/awt/AWTEvent;)V", methodCache: &ButtonPeerForward.handleEvent_MethodID_21, args: &__args, locals: &__locals )
    }
    ...
    override open func handlesWheelScrolling() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "handlesWheelScrolling", methodSig: "()Z", methodCache: &ButtonPeerForward.handlesWheelScrolling_MethodID_22, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var isFocusable_MethodID_23: jmethodID?

    override open func isFocusable() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFocusable", methodSig: "()Z", methodCache: &ButtonPeerForward.isFocusable_MethodID_23, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var isObscured_MethodID_24: jmethodID?

    override open func isObscured() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isObscured", methodSig: "()Z", methodCache: &ButtonPeerForward.isObscured_MethodID_24, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var isReparentSupported_MethodID_25: jmethodID?

    override open func isReparentSupported() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isReparentSupported", methodSig: "()Z", methodCache: &ButtonPeerForward.isReparentSupported_MethodID_25, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    private static var layout_MethodID_26: jmethodID?

    override open func layout() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "layout", methodSig: "()V", methodCache: &ButtonPeerForward.layout_MethodID_26, args: &__args, locals: &__locals )
    }
    ...
    override open func paint( g: Graphics? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "paint", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &ButtonPeerForward.paint_MethodID_27, args: &__args, locals: &__locals )
    }
    ...
    private static var prepareImage_MethodID_28: jmethodID?
    ...
    override open func prepareImage( img: Image?, w: Int, h: Int, o: ImageObserver? ) -> Bool {
        ...
        __args[2] = jvalue( i: jint(h) )
        __args[3] = JNIType.toJava( value: o, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "prepareImage", methodSig: "(Ljava/awt/Image;IILjava/awt/image/ImageObserver;)Z", methodCache: &ButtonPeerForward.prepareImage_MethodID_28, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func print( g: Graphics? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: g, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "print", methodSig: "(Ljava/awt/Graphics;)V", methodCache: &ButtonPeerForward.print_MethodID_29, args: &__args, locals: &__locals )
    }
    ...
    private static var reparent_MethodID_30: jmethodID?

    override open func reparent( newContainer: ContainerPeer? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: newContainer, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "reparent", methodSig: "(Ljava/awt/peer/ContainerPeer;)V", methodCache: &ButtonPeerForward.reparent_MethodID_30, args: &__args, locals: &__locals )
    }
    ...
    override open func requestFocus( lightweightChild: Component?, temporary: Bool, focusedWindowChangeAllowed: Bool, time: Int64, cause: /* class sun.awt.CausedFocusEvent$Cause */ UnavailableEnum? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "requestFocus", methodSig: "(Ljava/awt/Component;ZZJLsun/awt/CausedFocusEvent$Cause;)Z", methodCache: &ButtonPeerForward.requestFocus_MethodID_31, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
    ...
    override open func setBackground( c: Color? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBackground", methodSig: "(Ljava/awt/Color;)V", methodCache: &ButtonPeerForward.setBackground_MethodID_32, args: &__args, locals: &__locals )
    }
    ...
    private static var setBounds_MethodID_33: jmethodID?
    ...
    override open func setBounds( x: Int, y: Int, width: Int, height: Int, op: Int ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setBounds", methodSig: "(IIIII)V", methodCache: &ButtonPeerForward.setBounds_MethodID_33, args: &__args, locals: &__locals )
    }
    ...
    override open func setEnabled( e: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setEnabled", methodSig: "(Z)V", methodCache: &ButtonPeerForward.setEnabled_MethodID_34, args: &__args, locals: &__locals )
    }
    ...
    private static var setFont_MethodID_35: jmethodID?

    override open func setFont( f: Font? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: f, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setFont", methodSig: "(Ljava/awt/Font;)V", methodCache: &ButtonPeerForward.setFont_MethodID_35, args: &__args, locals: &__locals )
    }
    ...
    override open func setForeground( c: Color? ) {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: c, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setForeground", methodSig: "(Ljava/awt/Color;)V", methodCache: &ButtonPeerForward.setForeground_MethodID_36, args: &__args, locals: &__locals )
    }
    ...
    private static var setLabel_MethodID_37: jmethodID?

    open func setLabel( label: String? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: label, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setLabel", methodSig: "(Ljava/lang/String;)V", methodCache: &ButtonPeerForward.setLabel_MethodID_37, args: &__args, locals: &__locals )
    }
    ...
    override open func setVisible( v: Bool ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setVisible", methodSig: "(Z)V", methodCache: &ButtonPeerForward.setVisible_MethodID_38, args: &__args, locals: &__locals )
    }
    ...
    private static var setZOrder_MethodID_39: jmethodID?

    override open func setZOrder( above: ComponentPeer? ) {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: above, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setZOrder", methodSig: "(Ljava/awt/peer/ComponentPeer;)V", methodCache: &ButtonPeerForward.setZOrder_MethodID_39, args: &__args, locals: &__locals )
    }
    ...
    override open func updateCursorImmediately() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "updateCursorImmediately", methodSig: "()V", methodCache: &ButtonPeerForward.updateCursorImmediately_MethodID_40, args: &__args, locals: &__locals )
    }
    ...
    override open func updateGraphicsData( gc: GraphicsConfiguration? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "updateGraphicsData", methodSig: "(Ljava/awt/GraphicsConfiguration;)Z", methodCache: &ButtonPeerForward.updateGraphicsData_MethodID_41, args: &__args, locals: &__locals )
        return __return != jboolean(JNI_FALSE)
    }
