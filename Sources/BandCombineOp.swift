...
open class BandCombineOp: java_swift.JavaObject, RasterOp {
    ...
    private static var createCompatibleDestRaster_MethodID_2: jmethodID?

    open func createCompatibleDestRaster( src: Raster? ) -> WritableRaster! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: src, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createCompatibleDestRaster", methodSig: "(Ljava/awt/image/Raster;)Ljava/awt/image/WritableRaster;", methodCache: &BandCombineOp.createCompatibleDestRaster_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func filter( src: Raster?, dest: WritableRaster? ) -> WritableRaster! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "filter", methodSig: "(Ljava/awt/image/Raster;Ljava/awt/image/WritableRaster;)Ljava/awt/image/WritableRaster;", methodCache: &BandCombineOp.filter_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? WritableRaster( javaObject: __return ) : nil
    }
    ...
    private static var getPoint2D_MethodID_6: jmethodID?
    ...
    open func getPoint2D( srcPt: Point2D?, dstPt: Point2D? ) -> Point2D! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPoint2D", methodSig: "(Ljava/awt/geom/Point2D;Ljava/awt/geom/Point2D;)Ljava/awt/geom/Point2D;", methodCache: &BandCombineOp.getPoint2D_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getRenderingHints() -> RenderingHints! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getRenderingHints", methodSig: "()Ljava/awt/RenderingHints;", methodCache: &BandCombineOp.getRenderingHints_MethodID_7, args: &__args, locals: &__locals )
