...
open class SplashScreen: java_lang.JavaObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.SplashScreen", file, line ) {
            return nil
        }
    ...
    /// private long java.awt.SplashScreen.splashPtr

    /// private boolean java.awt.SplashScreen.wasClosed
    ...
    private static var close_MethodID_1: jmethodID?

    open func close() throws /* java.lang.IllegalStateException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "close", methodSig: "()V", methodCache: &SplashScreen.close_MethodID_1, args: &__args, locals: &__locals )
    ...
    private static var getSize_MethodID_2: jmethodID?

    open func getSize() throws /* java.lang.IllegalStateException */ -> Dimension! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSize", methodSig: "()Ljava/awt/Dimension;", methodCache: &SplashScreen.getSize_MethodID_2, args: &__args, locals: &__locals )
    ...
    open func update() throws /* java.lang.IllegalStateException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "update", methodSig: "()V", methodCache: &SplashScreen.update_MethodID_3, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw java_lang.IllegalStateException( javaObject: throwable )
        }
    }
    ...
    open func createGraphics() throws /* java.lang.IllegalStateException */ -> Graphics2D! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createGraphics", methodSig: "()Ljava/awt/Graphics2D;", methodCache: &SplashScreen.createGraphics_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw java_lang.IllegalStateException( javaObject: throwable )
        }
    ...
    private static var isVisible_MethodID_6: jmethodID?

    open func isVisible() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isVisible", methodSig: "()Z", methodCache: &SplashScreen.isVisible_MethodID_6, args: &__args, locals: &__locals )
    ...
    private static var getSplashScreen_MethodID_7: jmethodID?

    open class func getSplashScreen() -> SplashScreen! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/SplashScreen", classCache: &SplashScreenJNIClass, methodName: "getSplashScreen", methodSig: "()Ljava/awt/SplashScreen;", methodCache: &getSplashScreen_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func setImageURL( _ _arg0: /* java.net.URL */ UnclassedObject? ) throws /* java.lang.NullPointerException, java.io.IOException, java.lang.IllegalStateException */ {
    ...
    private static var getImageURL_MethodID_9: jmethodID?

    open func getImageURL() throws /* java.lang.IllegalStateException */ -> /* java.net.URL */ UnclassedObject! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getImageURL", methodSig: "()Ljava/net/URL;", methodCache: &SplashScreen.getImageURL_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw java_lang.IllegalStateException( javaObject: throwable )
        }
