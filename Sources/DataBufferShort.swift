...
open class DataBufferShort: DataBuffer {
    ...
    public convenience init( dataArray: [[Int16]]?, size: Int, offsets: [Int32]? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/image/DataBufferShort", classCache: &DataBufferShort.DataBufferShortJNIClass, methodSig: "([[SI[I)V", methodCache: &DataBufferShort.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( dataArray: [[Int16]]?, size: Int ) {
        ...
        __args[0] = JNIType.toJava( value: dataArray, locals: &__locals )
        __args[1] = JNIType.toJava( value: size, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/awt/image/DataBufferShort", classCache: &DataBufferShort.DataBufferShortJNIClass, methodSig: "([[SI)V", methodCache: &DataBufferShort.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( dataArray: [Int16]?, size: Int, offset: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/image/DataBufferShort", classCache: &DataBufferShort.DataBufferShortJNIClass, methodSig: "([SII)V", methodCache: &DataBufferShort.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( size: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/image/DataBufferShort", classCache: &DataBufferShort.DataBufferShortJNIClass, methodSig: "(I)V", methodCache: &DataBufferShort.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( size: Int, numBanks: Int ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/image/DataBufferShort", classCache: &DataBufferShort.DataBufferShortJNIClass, methodSig: "(II)V", methodCache: &DataBufferShort.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( dataArray: [Int16]?, size: Int ) {
        ...
        __args[0] = JNIType.toJava( value: dataArray, locals: &__locals )
        __args[1] = JNIType.toJava( value: size, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/awt/image/DataBufferShort", classCache: &DataBufferShort.DataBufferShortJNIClass, methodSig: "([SI)V", methodCache: &DataBufferShort.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
