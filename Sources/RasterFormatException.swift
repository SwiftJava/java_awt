...
open class RasterFormatException: java_lang.RuntimeException {

    public convenience init?( casting object: java_swift.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.image.RasterFormatException", file, line ) {
            return nil
        }
    ...
    private static var RasterFormatExceptionJNIClass: jclass?
    ...
    /// public java.awt.image.RasterFormatException(java.lang.String)
    ...
    public convenience init( s: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/image/RasterFormatException", classCache: &RasterFormatException.RasterFormatExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &RasterFormatException.new_MethodID_1, args: &__args, locals: &__locals )
