...
open class FlatteningPathIterator: java_swift.JavaObject, PathIterator {
    ...
    open func currentSegment( coords: [Double]? ) -> Int {
        ...
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "currentSegment", methodSig: "([D)I", methodCache: &FlatteningPathIterator.currentSegment_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    open func currentSegment( coords: [Float]? ) -> Int {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: coords, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "currentSegment", methodSig: "([F)I", methodCache: &FlatteningPathIterator.currentSegment_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getRecursionLimit_MethodID_8: jmethodID?

    open func getRecursionLimit() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getRecursionLimit", methodSig: "()I", methodCache: &FlatteningPathIterator.getRecursionLimit_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getFlatness_MethodID_9: jmethodID?

    open func getFlatness() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getFlatness", methodSig: "()D", methodCache: &FlatteningPathIterator.getFlatness_MethodID_9, args: &__args, locals: &__locals )
