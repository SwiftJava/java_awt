...
open class InvocationEvent: AWTEvent, ActiveEvent {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.awt.event.InvocationEvent", file, line ) {
            return nil
        }
    ...
    open var runnable: java_lang.Runnable! {
        get {
            ...
            return __value != nil ? java_lang.RunnableForward( javaObject: __value ) : nil
        }
        set(newValue) {
            var __locals = [jobject]()
    ...
    open var notifier: java_lang.JavaObject! {
        get {
            var __locals = [jobject]()
    ...
    public convenience init( arg0: java_lang.JavaObject?, arg1: java_lang.Runnable? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 2 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        __args[1] = jvalue( l: arg1?.localJavaObject( &__locals ) )
        let __object = JNIMethod.NewObject( className: "java/awt/event/InvocationEvent", classCache: &InvocationEvent.InvocationEventJNIClass, methodSig: "(Ljava/lang/Object;Ljava/lang/Runnable;)V", methodCache: &InvocationEvent.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _arg0: java_lang.JavaObject?, _ _arg1: java_lang.Runnable? ) {
    ...
    public convenience init( arg0: java_lang.JavaObject?, arg1: java_lang.Runnable?, arg2: java_lang.JavaObject?, arg3: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/event/InvocationEvent", classCache: &InvocationEvent.InvocationEventJNIClass, methodSig: "(Ljava/lang/Object;Ljava/lang/Runnable;Ljava/lang/Object;Z)V", methodCache: &InvocationEvent.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _arg0: java_lang.JavaObject?, _ _arg1: java_lang.Runnable?, _ _arg2: java_lang.JavaObject?, _ _arg3: Bool ) {
    ...
    public convenience init( arg0: java_lang.JavaObject?, arg1: Int, arg2: java_lang.Runnable?, arg3: java_lang.JavaObject?, arg4: Bool ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/event/InvocationEvent", classCache: &InvocationEvent.InvocationEventJNIClass, methodSig: "(Ljava/lang/Object;ILjava/lang/Runnable;Ljava/lang/Object;Z)V", methodCache: &InvocationEvent.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    public convenience init( _ _arg0: java_lang.JavaObject?, _ _arg1: Int, _ _arg2: java_lang.Runnable?, _ _arg3: java_lang.JavaObject?, _ _arg4: Bool ) {
        self.init( arg0: _arg0, arg1: _arg1, arg2: _arg2, arg3: _arg3, arg4: _arg4 )
    }

    /// public void java.awt.event.InvocationEvent.dispatch()

    private static var dispatch_MethodID_4: jmethodID?

    open func dispatch() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "dispatch", methodSig: "()V", methodCache: &InvocationEvent.dispatch_MethodID_4, args: &__args, locals: &__locals )
    }


    /// public java.lang.Exception java.awt.event.InvocationEvent.getException()

    private static var getException_MethodID_5: jmethodID?

    open func getException() -> java_lang.Exception! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getException", methodSig: "()Ljava/lang/Exception;", methodCache: &InvocationEvent.getException_MethodID_5, args: &__args, locals: &__locals )
    ...
    private static var getThrowable_MethodID_6: jmethodID?

    open func getThrowable() -> java_lang.Throwable! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getThrowable", methodSig: "()Ljava/lang/Throwable;", methodCache: &InvocationEvent.getThrowable_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
