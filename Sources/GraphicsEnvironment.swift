...
open class GraphicsEnvironment: java_lang.JavaObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.GraphicsEnvironment", file, line ) {
            return nil
        }
    ...
    /// static java.lang.Boolean java.awt.GraphicsEnvironment.access$002(java.lang.Boolean)

    /// static java.lang.Boolean java.awt.GraphicsEnvironment.access$102(java.lang.Boolean)
    ...
    private static var getAvailableFontFamilyNames_MethodID_5: jmethodID?

    open func getAvailableFontFamilyNames() -> [String]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAvailableFontFamilyNames", methodSig: "()[Ljava/lang/String;", methodCache: &GraphicsEnvironment.getAvailableFontFamilyNames_MethodID_5, args: &__args, locals: &__locals )
    ...
    open func getAvailableFontFamilyNames( arg0: java_util.JavaLocale? ) -> [String]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
    ...
    open func getAvailableFontFamilyNames( _ _arg0: java_util.JavaLocale? ) -> [String]! {
        return getAvailableFontFamilyNames( arg0: _arg0 )
    }
    ...
    open func createGraphics( arg0: BufferedImage? ) -> Graphics2D! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func createGraphics( _ _arg0: BufferedImage? ) -> Graphics2D! {
        return createGraphics( arg0: _arg0 )
    }
    ...
    private static var isHeadlessInstance_MethodID_8: jmethodID?

    open func isHeadlessInstance() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isHeadlessInstance", methodSig: "()Z", methodCache: &GraphicsEnvironment.isHeadlessInstance_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var getScreenDevices_MethodID_9: jmethodID?

    open func getScreenDevices() throws /* java.awt.HeadlessException */ -> [GraphicsDevice]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getScreenDevices", methodSig: "()[Ljava/awt/GraphicsDevice;", methodCache: &GraphicsEnvironment.getScreenDevices_MethodID_9, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw HeadlessException( javaObject: throwable )
        }
        return JNIType.decode( type: [GraphicsDevice](), from: __return )
    }


    /// public abstract java.awt.Font[] java.awt.GraphicsEnvironment.getAllFonts()

    private static var getAllFonts_MethodID_10: jmethodID?

    open func getAllFonts() -> [Font]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getAllFonts", methodSig: "()[Ljava/awt/Font;", methodCache: &GraphicsEnvironment.getAllFonts_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.decode( type: [Font](), from: __return )
    }
    ...
    open func registerFont( arg0: Font? ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func registerFont( _ _arg0: Font? ) -> Bool {
        return registerFont( arg0: _arg0 )
    }
