...
open class ProfileDataException: java_lang.RuntimeException {

    public convenience init?( casting object: java_swift.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.color.ProfileDataException", file, line ) {
            return nil
        }
    ...
    private static var ProfileDataExceptionJNIClass: jclass?
    ...
    /// public java.awt.color.ProfileDataException(java.lang.String)
    ...
    public convenience init( s: String? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/color/ProfileDataException", classCache: &ProfileDataException.ProfileDataExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &ProfileDataException.new_MethodID_1, args: &__args, locals: &__locals )
