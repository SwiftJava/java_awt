...
open class GraphicsConfiguration: java_swift.JavaObject {
    ...
    open func createCompatibleImage( width: Int, height: Int, transparency: Int ) -> BufferedImage! {
        ...
        __args[0] = jvalue( i: jint(width) )
        __args[1] = jvalue( i: jint(height) )
        __args[2] = jvalue( i: jint(transparency) )
    ...
    open func createCompatibleVolatileImage( width: Int, height: Int ) -> VolatileImage! {
        ...
        __args[0] = jvalue( i: jint(width) )
        __args[1] = jvalue( i: jint(height) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createCompatibleVolatileImage", methodSig: "(II)Ljava/awt/image/VolatileImage;", methodCache: &GraphicsConfiguration.createCompatibleVolatileImage_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func createCompatibleVolatileImage( width: Int, height: Int, caps: ImageCapabilities?, transparency: Int ) throws /* java.awt.AWTException */ -> VolatileImage! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createCompatibleVolatileImage", methodSig: "(IILjava/awt/ImageCapabilities;I)Ljava/awt/image/VolatileImage;", methodCache: &GraphicsConfiguration.createCompatibleVolatileImage_MethodID_6, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw AWTException( javaObject: throwable )
    ...
    open func createCompatibleVolatileImage( width: Int, height: Int, transparency: Int ) -> VolatileImage! {
        ...
        __args[1] = jvalue( i: jint(height) )
        __args[2] = jvalue( i: jint(transparency) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "createCompatibleVolatileImage", methodSig: "(III)Ljava/awt/image/VolatileImage;", methodCache: &GraphicsConfiguration.createCompatibleVolatileImage_MethodID_7, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? VolatileImage( javaObject: __return ) : nil
    }
    ...
    open func getBounds() -> Rectangle! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBounds", methodSig: "()Ljava/awt/Rectangle;", methodCache: &GraphicsConfiguration.getBounds_MethodID_8, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getBufferCapabilities_MethodID_9: jmethodID?

    open func getBufferCapabilities() -> BufferCapabilities! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBufferCapabilities", methodSig: "()Ljava/awt/BufferCapabilities;", methodCache: &GraphicsConfiguration.getBufferCapabilities_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getColorModel( transparency: Int ) -> ColorModel! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(transparency) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColorModel", methodSig: "(I)Ljava/awt/image/ColorModel;", methodCache: &GraphicsConfiguration.getColorModel_MethodID_10, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getColorModel() -> ColorModel! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColorModel", methodSig: "()Ljava/awt/image/ColorModel;", methodCache: &GraphicsConfiguration.getColorModel_MethodID_11, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? ColorModel( javaObject: __return ) : nil
    }
    ...
    private static var getDefaultTransform_MethodID_12: jmethodID?

    open func getDefaultTransform() -> AffineTransform! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDefaultTransform", methodSig: "()Ljava/awt/geom/AffineTransform;", methodCache: &GraphicsConfiguration.getDefaultTransform_MethodID_12, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getDevice_MethodID_13: jmethodID?

    open func getDevice() -> GraphicsDevice! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getDevice", methodSig: "()Ljava/awt/GraphicsDevice;", methodCache: &GraphicsConfiguration.getDevice_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getImageCapabilities_MethodID_14: jmethodID?

    open func getImageCapabilities() -> ImageCapabilities! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getImageCapabilities", methodSig: "()Ljava/awt/ImageCapabilities;", methodCache: &GraphicsConfiguration.getImageCapabilities_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    private static var getNormalizingTransform_MethodID_15: jmethodID?

    open func getNormalizingTransform() -> AffineTransform! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getNormalizingTransform", methodSig: "()Ljava/awt/geom/AffineTransform;", methodCache: &GraphicsConfiguration.getNormalizingTransform_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? AffineTransform( javaObject: __return ) : nil
    }
    ...
    private static var isTranslucencyCapable_MethodID_16: jmethodID?

    open func isTranslucencyCapable() -> Bool {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isTranslucencyCapable", methodSig: "()Z", methodCache: &GraphicsConfiguration.isTranslucencyCapable_MethodID_16, args: &__args, locals: &__locals )
