...
open class ICC_Profile: java_swift.JavaObject, /* interface java.io.Serializable */ UnavailableProtocol {
    ...
    open class func getInstance( arg0: Int ) -> ICC_Profile! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/color/ICC_Profile", classCache: &ICC_ProfileJNIClass, methodName: "getInstance", methodSig: "(I)Ljava/awt/color/ICC_Profile;", methodCache: &getInstance_MethodID_1, args: &__args, locals: &__locals )
    ...
    open class func getInstance( arg0: String? ) throws /* java.io.IOException */ -> ICC_Profile! {
        ...
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/color/ICC_Profile", classCache: &ICC_ProfileJNIClass, methodName: "getInstance", methodSig: "(Ljava/lang/String;)Ljava/awt/color/ICC_Profile;", methodCache: &getInstance_MethodID_2, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open class func getInstance( arg0: /* class java.io.InputStream */ UnavailableObject? ) throws /* java.io.IOException */ -> ICC_Profile! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/color/ICC_Profile", classCache: &ICC_ProfileJNIClass, methodName: "getInstance", methodSig: "(Ljava/io/InputStream;)Ljava/awt/color/ICC_Profile;", methodCache: &getInstance_MethodID_3, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw /* class java.io.IOException */ UnavailableObject( javaObject: throwable )
    ...
    open class func getInstance( _ _arg0: /* class java.io.InputStream */ UnavailableObject? ) throws /* java.io.IOException */ -> ICC_Profile! {
        return try getInstance( arg0: _arg0 )
    }
    ...
    open class func getInstance( arg0: [Int8]? ) -> ICC_Profile! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/color/ICC_Profile", classCache: &ICC_ProfileJNIClass, methodName: "getInstance", methodSig: "([B)Ljava/awt/color/ICC_Profile;", methodCache: &getInstance_MethodID_4, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? ICC_Profile( javaObject: __return ) : nil
    }
    ...
    override open func finalize() {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "finalize", methodSig: "()V", methodCache: &ICC_Profile.finalize_MethodID_5, args: &__args, locals: &__locals )
    }


    /// public int java.awt.color.ICC_Profile.getColorSpaceType()

    private static var getColorSpaceType_MethodID_6: jmethodID?

    open func getColorSpaceType() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getColorSpaceType", methodSig: "()I", methodCache: &ICC_Profile.getColorSpaceType_MethodID_6, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    open func getData( arg0: Int ) -> [Int8]! {
        ...
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = jvalue( i: jint(arg0) )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getData", methodSig: "(I)[B", methodCache: &ICC_Profile.getData_MethodID_7, args: &__args, locals: &__locals )
    ...
    open func getData() -> [Int8]! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getData", methodSig: "()[B", methodCache: &ICC_Profile.getData_MethodID_8, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: [Int8].self, from: __return )
    }
    ...
    private static var getMajorVersion_MethodID_9: jmethodID?

    open func getMajorVersion() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMajorVersion", methodSig: "()I", methodCache: &ICC_Profile.getMajorVersion_MethodID_9, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getMinorVersion_MethodID_10: jmethodID?

    open func getMinorVersion() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getMinorVersion", methodSig: "()I", methodCache: &ICC_Profile.getMinorVersion_MethodID_10, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var getPCSType_MethodID_12: jmethodID?

    open func getPCSType() -> Int {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getPCSType", methodSig: "()I", methodCache: &ICC_Profile.getPCSType_MethodID_12, args: &__args, locals: &__locals )
        return Int(__return)
    }
    ...
    private static var readResolve_MethodID_14: jmethodID?

    open func readResolve() throws /* java.io.ObjectStreamException */ -> java_swift.JavaObject! {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "readResolve", methodSig: "()Ljava/lang/Object;", methodCache: &ICC_Profile.readResolve_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
    ...
    private static var setData_MethodID_15: jmethodID?
    ...
    open func setData( arg0: Int, arg1: [Int8]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setData", methodSig: "(I[B)V", methodCache: &ICC_Profile.setData_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    private static var write_MethodID_16: jmethodID?

    open func write( arg0: String? ) throws /* java.io.IOException */ {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "write", methodSig: "(Ljava/lang/String;)V", methodCache: &ICC_Profile.write_MethodID_16, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw /* class java.io.IOException */ UnavailableObject( javaObject: throwable )
        }
    ...
    private static var write_MethodID_17: jmethodID?

    open func write( arg0: /* class java.io.OutputStream */ UnavailableObject? ) throws /* java.io.IOException */ {
        var __locals = [jobject]()
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        __args[0] = JNIType.toJava( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "write", methodSig: "(Ljava/io/OutputStream;)V", methodCache: &ICC_Profile.write_MethodID_17, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            defer { JNI.DeleteLocalRef( throwable ) }
            throw /* class java.io.IOException */ UnavailableObject( javaObject: throwable )
        }
    ...
    open func write( _ _arg0: /* class java.io.OutputStream */ UnavailableObject? ) throws /* java.io.IOException */ {
        try write( arg0: _arg0 )
    }
