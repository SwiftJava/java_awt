...
open class GlyphVector: java_swift.JavaObject, java_lang.Cloneable {
    ...
    private static var getVisualBounds_MethodID_28: jmethodID?

    open func getVisualBounds() -> Rectangle2D! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getVisualBounds", methodSig: "()Ljava/awt/geom/Rectangle2D;", methodCache: &GlyphVector.getVisualBounds_MethodID_28, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? Rectangle2D( javaObject: __return ) : nil
    }
