...
open class GraphicsDevice: java_lang.JavaObject {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.GraphicsDevice", file, line ) {
            return nil
        }
    ...
    private static var getIDstring_MethodID_4: jmethodID?

    open func getIDstring() -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getIDstring", methodSig: "()Ljava/lang/String;", methodCache: &GraphicsDevice.getIDstring_MethodID_4, args: &__args, locals: &__locals )
    ...
    private static var getBestConfiguration_MethodID_5: jmethodID?

    open func getBestConfiguration( arg0: GraphicsConfigTemplate? ) -> GraphicsConfiguration! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBestConfiguration", methodSig: "(Ljava/awt/GraphicsConfigTemplate;)Ljava/awt/GraphicsConfiguration;", methodCache: &GraphicsDevice.getBestConfiguration_MethodID_5, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? GraphicsConfiguration( javaObject: __return ) : nil
    }

    open func getBestConfiguration( _ _arg0: GraphicsConfigTemplate? ) -> GraphicsConfiguration! {
    ...
    private static var getConfigurations_MethodID_6: jmethodID?

    open func getConfigurations() -> [GraphicsConfiguration]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getConfigurations", methodSig: "()[Ljava/awt/GraphicsConfiguration;", methodCache: &GraphicsDevice.getConfigurations_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.decode( type: [GraphicsConfiguration](), from: __return )
    }


    /// public boolean java.awt.GraphicsDevice.isFullScreenSupported()

    private static var isFullScreenSupported_MethodID_7: jmethodID?

    open func isFullScreenSupported() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isFullScreenSupported", methodSig: "()Z", methodCache: &GraphicsDevice.isFullScreenSupported_MethodID_7, args: &__args, locals: &__locals )
    ...
    private static var setFullScreenWindow_MethodID_8: jmethodID?

    open func setFullScreenWindow( arg0: Window? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setFullScreenWindow", methodSig: "(Ljava/awt/Window;)V", methodCache: &GraphicsDevice.setFullScreenWindow_MethodID_8, args: &__args, locals: &__locals )
    }

    open func setFullScreenWindow( _ _arg0: Window? ) {
        setFullScreenWindow( arg0: _arg0 )
    }

    /// public java.awt.Window java.awt.GraphicsDevice.getFullScreenWindow()

    private static var getFullScreenWindow_MethodID_9: jmethodID?

    open func getFullScreenWindow() -> Window! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getFullScreenWindow", methodSig: "()Ljava/awt/Window;", methodCache: &GraphicsDevice.getFullScreenWindow_MethodID_9, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func setDisplayMode( arg0: DisplayMode? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func setDisplayMode( _ _arg0: DisplayMode? ) {
        setDisplayMode( arg0: _arg0 )
    }
    ...
    open func getDisplayModes() -> [DisplayMode]! {
        ...
        return JNIType.decode( type: [DisplayMode](), from: __return )
    }
