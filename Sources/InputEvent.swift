...
open class InputEvent: ComponentEvent {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.awt.event.InputEvent", file, line ) {
            return nil
        }
    ...
    /// private static void java.awt.event.InputEvent.initIDs()
    ...
    private static var isConsumed_MethodID_3: jmethodID?

    override open func isConsumed() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isConsumed", methodSig: "()Z", methodCache: &InputEvent.isConsumed_MethodID_3, args: &__args, locals: &__locals )
    ...
    override open func consume() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "consume", methodSig: "()V", methodCache: &InputEvent.consume_MethodID_4, args: &__args, locals: &__locals )
    }


    /// public boolean java.awt.event.InputEvent.isControlDown()

    private static var isControlDown_MethodID_5: jmethodID?

    open func isControlDown() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isControlDown", methodSig: "()Z", methodCache: &InputEvent.isControlDown_MethodID_5, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var isShiftDown_MethodID_6: jmethodID?

    open func isShiftDown() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isShiftDown", methodSig: "()Z", methodCache: &InputEvent.isShiftDown_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var getModifiersEx_MethodID_7: jmethodID?

    open func getModifiersEx() -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getModifiersEx", methodSig: "()I", methodCache: &InputEvent.getModifiersEx_MethodID_7, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int(), from: __return )
    }
    ...
    private static var getModifiersExText_MethodID_8: jmethodID?

    open class func getModifiersExText( arg0: Int ) -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __return = JNIMethod.CallStaticObjectMethod( className: "java/awt/event/InputEvent", classCache: &InputEventJNIClass, methodName: "getModifiersExText", methodSig: "(I)Ljava/lang/String;", methodCache: &getModifiersExText_MethodID_8, args: &__args, locals: &__locals )
    ...
    private static var isMetaDown_MethodID_9: jmethodID?

    open func isMetaDown() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isMetaDown", methodSig: "()Z", methodCache: &InputEvent.isMetaDown_MethodID_9, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var isAltDown_MethodID_10: jmethodID?

    open func isAltDown() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isAltDown", methodSig: "()Z", methodCache: &InputEvent.isAltDown_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var isAltGraphDown_MethodID_11: jmethodID?

    open func isAltGraphDown() -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isAltGraphDown", methodSig: "()Z", methodCache: &InputEvent.isAltGraphDown_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
