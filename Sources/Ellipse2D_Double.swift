...
open class Ellipse2D_Double: Ellipse2D, /* java.io.Serializable */ UnclassedProtocol {
    ...
    public convenience init( arg0: Double, arg1: Double, arg2: Double, arg3: Double ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/awt/geom/Ellipse2D$Double", classCache: &Ellipse2D_Double.Ellipse2D_DoubleJNIClass, methodSig: "(DDDD)V", methodCache: &Ellipse2D_Double.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init() {
        ...
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/awt/geom/Ellipse2D$Double", classCache: &Ellipse2D_Double.Ellipse2D_DoubleJNIClass, methodSig: "()V", methodCache: &Ellipse2D_Double.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
