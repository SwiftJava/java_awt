...
open class QuadCurve2D: java_swift.JavaObject, Shape, java_lang.Cloneable {
    ...
    open func contains( p: Point2D? ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "contains", methodSig: "(Ljava/awt/geom/Point2D;)Z", methodCache: &QuadCurve2D.contains_MethodID_4, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func contains( x: Double, y: Double, w: Double, h: Double ) -> Bool {
        ...
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "contains", methodSig: "(DDDD)Z", methodCache: &QuadCurve2D.contains_MethodID_6, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Bool(), from: __return )
    }
    ...
    open func getX1() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getX1", methodSig: "()D", methodCache: &QuadCurve2D.getX1_MethodID_9, args: &__args, locals: &__locals )
    ...
    open func getY1() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getY1", methodSig: "()D", methodCache: &QuadCurve2D.getY1_MethodID_10, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func getX2() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getX2", methodSig: "()D", methodCache: &QuadCurve2D.getX2_MethodID_11, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func getY2() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getY2", methodSig: "()D", methodCache: &QuadCurve2D.getY2_MethodID_12, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func getBounds() -> Rectangle! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getBounds", methodSig: "()Ljava/awt/Rectangle;", methodCache: &QuadCurve2D.getBounds_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getPathIterator( at: AffineTransform? ) -> PathIterator! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPathIterator", methodSig: "(Ljava/awt/geom/AffineTransform;)Ljava/awt/geom/PathIterator;", methodCache: &QuadCurve2D.getPathIterator_MethodID_14, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func getPathIterator( at: AffineTransform?, flatness: Double ) -> PathIterator! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getPathIterator", methodSig: "(Ljava/awt/geom/AffineTransform;D)Ljava/awt/geom/PathIterator;", methodCache: &QuadCurve2D.getPathIterator_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        return __return != nil ? PathIteratorForward( javaObject: __return ) : nil
    }
    ...
    private static var solveQuadratic_MethodID_16: jmethodID?
    ...
    open class func solveQuadratic( eqn: [Double]?, res: [Double]? ) -> Int {
        ...
        let __return = JNIMethod.CallStaticIntMethod( className: "java/awt/geom/QuadCurve2D", classCache: &QuadCurve2DJNIClass, methodName: "solveQuadratic", methodSig: "([D[D)I", methodCache: &solveQuadratic_MethodID_16, args: &__args, locals: &__locals )
    ...
    private static var solveQuadratic_MethodID_17: jmethodID?

    open class func solveQuadratic( eqn: [Double]? ) -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: eqn, locals: &__locals )
        let __return = JNIMethod.CallStaticIntMethod( className: "java/awt/geom/QuadCurve2D", classCache: &QuadCurve2DJNIClass, methodName: "solveQuadratic", methodSig: "([D)I", methodCache: &solveQuadratic_MethodID_17, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Int(), from: __return )
    }
    ...
    private static var getCtrlX_MethodID_18: jmethodID?

    open func getCtrlX() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getCtrlX", methodSig: "()D", methodCache: &QuadCurve2D.getCtrlX_MethodID_18, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    private static var getCtrlY_MethodID_19: jmethodID?

    open func getCtrlY() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getCtrlY", methodSig: "()D", methodCache: &QuadCurve2D.getCtrlY_MethodID_19, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    private static var getCtrlPt_MethodID_20: jmethodID?

    open func getCtrlPt() -> Point2D! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getCtrlPt", methodSig: "()Ljava/awt/geom/Point2D;", methodCache: &QuadCurve2D.getCtrlPt_MethodID_20, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
    ...
    open func setCurve( c: QuadCurve2D? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCurve", methodSig: "(Ljava/awt/geom/QuadCurve2D;)V", methodCache: &QuadCurve2D.setCurve_MethodID_23, args: &__args, locals: &__locals )
    }
    ...
    open func setCurve( p1: Point2D?, cp: Point2D?, p2: Point2D? ) {
        ...
        __args[1] = JNIType.toJava( value: cp != nil ? cp! as JNIObject : nil, locals: &__locals )
        __args[2] = JNIType.toJava( value: p2 != nil ? p2! as JNIObject : nil, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCurve", methodSig: "(Ljava/awt/geom/Point2D;Ljava/awt/geom/Point2D;Ljava/awt/geom/Point2D;)V", methodCache: &QuadCurve2D.setCurve_MethodID_25, args: &__args, locals: &__locals )
    }
    ...
    open func setCurve( coords: [Double]?, offset: Int ) {
        ...
        __args[1] = JNIType.toJava( value: offset, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCurve", methodSig: "([DI)V", methodCache: &QuadCurve2D.setCurve_MethodID_26, args: &__args, locals: &__locals )
    }
    ...
    open func setCurve( x1: Double, y1: Double, ctrlx: Double, ctrly: Double, x2: Double, y2: Double ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "setCurve", methodSig: "(DDDDDD)V", methodCache: &QuadCurve2D.setCurve_MethodID_27, args: &__args, locals: &__locals )
    }
    ...
    open class func getFlatnessSq( coords: [Double]?, offset: Int ) -> Double {
        ...
        __args[0] = JNIType.toJava( value: coords, locals: &__locals )
        __args[1] = JNIType.toJava( value: offset, locals: &__locals )
        let __return = JNIMethod.CallStaticDoubleMethod( className: "java/awt/geom/QuadCurve2D", classCache: &QuadCurve2DJNIClass, methodName: "getFlatnessSq", methodSig: "([DI)D", methodCache: &getFlatnessSq_MethodID_29, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func getFlatnessSq() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getFlatnessSq", methodSig: "()D", methodCache: &QuadCurve2D.getFlatnessSq_MethodID_30, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open class func getFlatness( x1: Double, y1: Double, ctrlx: Double, ctrly: Double, x2: Double, y2: Double ) -> Double {
        ...
        __args[4] = JNIType.toJava( value: x2, locals: &__locals )
        __args[5] = JNIType.toJava( value: y2, locals: &__locals )
        let __return = JNIMethod.CallStaticDoubleMethod( className: "java/awt/geom/QuadCurve2D", classCache: &QuadCurve2DJNIClass, methodName: "getFlatness", methodSig: "(DDDDDD)D", methodCache: &getFlatness_MethodID_31, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func getFlatness() -> Double {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallDoubleMethod( object: javaObject, methodName: "getFlatness", methodSig: "()D", methodCache: &QuadCurve2D.getFlatness_MethodID_32, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open class func getFlatness( coords: [Double]?, offset: Int ) -> Double {
        ...
        __args[0] = JNIType.toJava( value: coords, locals: &__locals )
        __args[1] = JNIType.toJava( value: offset, locals: &__locals )
        let __return = JNIMethod.CallStaticDoubleMethod( className: "java/awt/geom/QuadCurve2D", classCache: &QuadCurve2DJNIClass, methodName: "getFlatness", methodSig: "([DI)D", methodCache: &getFlatness_MethodID_33, args: &__args, locals: &__locals )
        return JNIType.toSwift( type: Double(), from: __return )
    }
    ...
    open func subdivide( left: QuadCurve2D?, right: QuadCurve2D? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "subdivide", methodSig: "(Ljava/awt/geom/QuadCurve2D;Ljava/awt/geom/QuadCurve2D;)V", methodCache: &QuadCurve2D.subdivide_MethodID_34, args: &__args, locals: &__locals )
    }
    ...
    open class func subdivide( src: [Double]?, srcoff: Int, left: [Double]?, leftoff: Int, right: [Double]?, rightoff: Int ) {
        ...
        JNIMethod.CallStaticVoidMethod( className: "java/awt/geom/QuadCurve2D", classCache: &QuadCurve2DJNIClass, methodName: "subdivide", methodSig: "([DI[DI[DI)V", methodCache: &subdivide_MethodID_35, args: &__args, locals: &__locals )
    }
    ...
    open class func subdivide( src: QuadCurve2D?, left: QuadCurve2D?, right: QuadCurve2D? ) {
        ...
        JNIMethod.CallStaticVoidMethod( className: "java/awt/geom/QuadCurve2D", classCache: &QuadCurve2DJNIClass, methodName: "subdivide", methodSig: "(Ljava/awt/geom/QuadCurve2D;Ljava/awt/geom/QuadCurve2D;Ljava/awt/geom/QuadCurve2D;)V", methodCache: &subdivide_MethodID_36, args: &__args, locals: &__locals )
    }
