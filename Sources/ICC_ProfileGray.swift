...
/// Tue Dec 20 11:35:01 GMT 2016 ///

/// class java.awt.color.ICC_ProfileGray ///

open class ICC_ProfileGray: ICC_Profile {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.awt.color.ICC_ProfileGray", file, line ) {
            return nil
        }
    ...
    private static var ICC_ProfileGrayJNIClass: jclass?
    ...
    /// java.awt.color.ICC_ProfileGray(long)

    /// java.awt.color.ICC_ProfileGray(sun.awt.color.ProfileDeferralInfo)
